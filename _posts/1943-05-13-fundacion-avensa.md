...
excerpt: "El 13 de mayo de 1943 se fundó en Caracas AVENSA (Aerovías Venezolanas Sociedad Anónima), una de las aerolíneas más importantes de Venezuela. Apoyada por Pan American World Airways y Mexicana de Aviación, se convirtió en un símbolo de progreso durante más de seis décadas."
image: 1943-05-13-fundacion-avensa.webp
---

<figure>
  <img class="post-image" src="{{ site.baseurl }}/assets/img/1943-05-13-fundacion-avensa.webp" alt="Aeronave Ford Trimotor de AVENSA">
...
- **Fecha de fundación:** 13 de mayo de 1943
- **Lugar:** Caracas, Venezuela
- **Nombre completo:** Aerovías Venezolanas Sociedad Anónima (AVENSA)
- **Fundadores:** John Boulton y Andrés Boulton
- **Socio internacional:** Pan American World Airways (Pan Am)
- **Apoyo adicional:** Mexicana de Aviación
- **Inicio de operaciones:** Diciembre de 1943
- **Vuelo inaugural:** Caracas - Ciudad Bolívar
- **Primeras aeronaves:** Ford Trimotor ("Tin Goose") y Stinson Reliant
...
- **Época de hélice:** Ford Trimotor, Stinson Reliant, Lockheed 10 Electra, Douglas DC-3, Douglas DC-4, Douglas DC-6, Convair 340/440, Vickers Viscount.
...
La fundación de AVENSA se enmarca en el esfuerzo de modernización de Venezuela durante la década de 1940. El auge petrolero proporcionó los recursos para desarrollar infraestructura y servicios, y la aviación comercial era un símbolo de progreso.
...
- **Diciembre de 1943:** Se realiza el vuelo inaugural con un Ford Trimotor en la ruta Caracas - Ciudad Bolívar.
- **1944:** Inicia los vuelos regulares de pasajeros.
- **1955:** Introduce los primeros aviones presurizados (Convair 340) en sus rutas internacionales a Miami.
- **1961:** AVENSA transfiere sus rutas internacionales a la recién creada VIASA, de la cual se convierte en accionista.
- **1964:** Incorpora su primer reactor, el Sud Aviation Caravelle, iniciando la era del jet en Venezuela.
- **1976:** El Estado venezolano adquiere las acciones de Pan Am, nacionalizando completamente la aerolínea.
- **1990/1991:** Moderniza su flota con la introducción de los Boeing 757-200 y 737-300.
- **1998:** Retoma vuelos internacionales con un DC-10-30 a Madrid, tras la quiebra de VIASA.
...
- **Pionera de la aviación venezolana:** AVENSA fue la primera aerolínea privada en modernizar la aviación comercial en el país.
- **Formación de profesionales:** Su escuela técnica formó a generaciones de mecánicos, pilotos y personal de tierra.
...
La historia de AVENSA es la historia de la moderna aviación comercial venezolana. Fue la aerolínea que democratizó el transporte aéreo en el país, conectando ciudades remotas con la capital y llevando el nombre de Venezuela al mundo. AVENSA no era solo una empresa; era parte de la identidad nacional, y su extinción dejó un vacío que ninguna otra aerolínea ha podido llenar.
