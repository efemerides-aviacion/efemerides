...
excerpt: "El 6 de mayo de 1935 voló por primera vez en Buffalo, Nueva York, el prototipo Curtiss-Wright Model 75, X17Y, diseñado por Donovan Reese Berlin. Este avanzado caza monoplano de construcción totalmente metálica, con tren de aterrizaje retráctil, daría origen al P-36 Hawk y sentaría las bases del posterior P-40 Warhawk."
image: 1935-05-06-primer-vuelo-curtiss-wright-model-75-x17y.webp
---

<figure>
  <img class="post-image" src="{{ site.baseurl }}/assets/img/1935-05-06-primer-vuelo-curtiss-wright-model-75-x17y.webp" alt="Curtiss-Wright Model 75 X17Y durante su primer vuelo">
...
- **Motor original:** Wright Aeronautical Division GR1670A1 (14 cilindros en doble estrella, 1.667 pulgadas cúbicas / 27,3 litros)
- **Potencia del motor:** 775 hp a nivel del mar, 830 hp al despegue
- **Velocidad alcanzada en primeras pruebas:** 452 km/h (281 mph) a 3.050 m (10.000 pies)
- **Tipo:** Caza monoplaza monomotor de ala baja
- **Construcción:** Totalmente metálica, con superficies de control enteladas
...
El Curtiss-Wright Model 75 fue el primer caza monoplano moderno de construcción metálica en entrar en servicio con el USAAC (aunque el Seversky P-35 fue el primero en cantidad, el P-36 llegó poco después). Marcó la transición definitiva de los biplanos de tela y alambre a los elegantes monoplanos de metal que dominarían los cielos de la Segunda Guerra Mundial.
