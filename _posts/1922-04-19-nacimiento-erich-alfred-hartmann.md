...
excerpt: "El 19 de abril de 1922 nació en Weissach, Alemania, Erich Alfred Hartmann, el as de caza más exitoso de la historia del combate aéreo, con 352 victorias acreditadas, quien voló 1.404 misiones de combate y nunca perdió a un compañero de escuadrilla."
image: 1922-04-19-nacimiento-erich-alfred-hartmann.webp
---

<figure>
  <img class="post-image" src="{{ site.baseurl }}/assets/img/1922-04-19-nacimiento-erich-alfred-hartmann.webp" alt="Erich Hartmann en uniforme de la Luftwaffe">
...
- **Unidad:** Jagdgeschwader 52 (JG 52)
- **Aeronave principal:** Messerschmitt Bf 109
- **Misiones de combate:** 1.404
- **Enfrentamientos aéreos:** 825
- **Veces derribado:** 16 (nunca por fuego enemigo directo, sino por esquirlas o fallos mecánicos)
- **Victorias confirmadas:** 352 (345 soviéticas, 7 estadounidenses)
...
Erich Hartmann nació en la Alemania de la posguerra de la Primera Guerra Mundial, un país sumido en una profunda crisis económica y política. El Tratado de Versalles (1919) prohibía a Alemania tener fuerza aérea, lo que paradójicamente impulsó el desarrollo del vuelo sin motor (planeadores) como una actividad deportiva y de entrenamiento encubierto.

### Entorno social

La familia Hartmann emigró a China entre 1925 y 1929 para escapar de la hiperinflación alemana. El padre de Erich, Alfred Hartmann, ejerció como médico en Changsha, en la provincia de Hunan, donde la familia residió en la isla de Yuelu (hoy isla de Juzizhou). Este período en China expuso al joven Erich a una cultura diferente y, según algunas fuentes, le permitió aprender algunas frases en dialecto de Changsha.

### Entorno tecnológico

La madre de Erich, Elisabeth Hartmann, fue una de las primeras mujeres alemanas en obtener una licencia de piloto de planeadores. En 1936 fundó un club de vuelo sin motor, y fue ella quien introdujo a Erich en el mundo de la aviación. A los 15 años, Hartmann ya era instructor de vuelo en planeadores en las Juventudes Hitlerianas.
...
- **1936:** Su madre, Elisabeth, obtiene su licencia de piloto de planeadores y funda un club de vuelo.
- **1937:** A los 15 años, Hartmann obtiene su licencia de piloto de planeadores y se convierte en instructor.
- **1939:** Obtiene su licencia de piloto de motor.
- **1 de octubre de 1940:** Se alista voluntariamente como candidato a oficial en la Luftwaffe.
- **1941:** Completa su entrenamiento básico y de vuelo.
- **Marzo de 1942:** Se gradúa como piloto de combate y es destinado al Jagdgeschwader 52 (JG 52).
- **Octubre de 1942:** Llega al Frente Oriental.
- **5 de noviembre de 1942:** Derriba su primer avión, un Ilyushin Il-2, en su misión número 19.
- **Julio de 1943:** Durante la Batalla de Kursk, se convierte en "as en un día" al derribar 7 aviones en una sola jornada.
- **Agosto de 1943:** Alcanza las 50 victorias.
...
- **1956:** Se une a la recién creada Bundeswehr (Fuerza Aérea de Alemania Occidental).
- **1959:** Se convierte en comandante del primer escuadrón de cazas a reacción de la Bundeswehr (JG 71 "Richthofen"), volando cazas Lockheed F-104 Starfighter.
...
- **Modelo para la Bundeswehr:** Después de la guerra, Hartmann se convirtió en un símbolo de la reconciliación y de la nueva Fuerza Aérea Alemana. Su integración en la Bundeswehr ayudó a legitimar el rearme de Alemania Occidental en el contexto de la Guerra Fría.
...
Erich Hartmann es, sin discusión, el as de caza más exitoso de la historia del combate aéreo. Su nombre aparece en todos los libros de historia de la aviación militar, y su récord de 352 derribos se considera inalcanzable en la era moderna, donde los combates aéreos ya no alcanzan la escala masiva de la Segunda Guerra Mundial.

Su legado, sin embargo, es complejo. Por un lado, fue un piloto excepcional que sirvió a un régimen criminal. Por otro lado, fue un hombre que, según todos los testimonios, mantuvo un código de honor: nunca perdió a un compañero, nunca disparó a pilotos en paracaídas, y pasó una década en un gulag soviético antes de ser exonerado.

La biografía autorizada de Hartmann, "The Blond Knight of Germany" (El Caballero Rubio de Alemania), escrita por Raymond F. Toliver y Trevor J. Constable, fue publicada en 1970 y sigue siendo la referencia estándar sobre su vida.
