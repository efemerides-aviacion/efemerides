...
excerpt: "El 22 de mayo de 1920, el gobierno venezolano formalizó la contratación de una misión de instructores franceses para la recién creada Escuela de Aviación Militar. La misión, compuesta por veteranos pilotos de la Primera Guerra Mundial como Robert Petit, Georges Teppe y Robert Guérin, sentó las bases técnicas y pedagógicas de la aviación militar venezolana."
image: 1920-05-22-mision-instructores-franceses-eam-venezolana.webp
---

<figure>
  <img class="post-image" src="{{ site.baseurl }}/assets/img/1920-05-22-mision-instructores-franceses-eam-venezolana.webp" alt="Misión francesa de instructores en Venezuela, 1920">
  <figcaption class="post-caption">Composición representativa con las imágenes de algunos de los integrantes de la Misión Francesa y algunos de los Alumnos Pioneros de la Escuela de Aviación Militar de Venezuela. Fuente: Valores Patrios / Gral. Gustavo Machado.</figcaption>
</figure>
<hr style="margin: 2rem 0; border: none; height: 2px; background: linear-gradient(to right, #1565c0, #42a5f5);">

<!-- ## Resumen Ejecutivo -->
<div class="highlight-box">
<p>El 22 de mayo de 1920, el Ministro de Guerra y Marina de Venezuela comunicó al Ministro de Relaciones Exteriores la instrucción presidencial de gestionar ante Francia la contratación de una misión de instructores aeronáuticos. Esta decisión, adoptada solo cinco semanas después del decreto de creación de la Escuela de Aviación Militar (17 de abril de 1920), buscaba dotar a la naciente institución de personal técnico calificado. La misión francesa, compuesta por veteranos pilotos de la Primera Guerra Mundial, incluía un jefe piloto, instructores de vuelo, mecánicos especialistas y personal para hidroaviones. Su llegada marcó el inicio efectivo de la aviación militar en Venezuela.</p>
</div>
<hr style="margin: 2rem 0; border: none; height: 2px; background: linear-gradient(to right, #1565c0, #42a5f5);">
...
- **Instructores franceses identificados:** Robert Petit, Ludovit Pouget, Luis Rollin, Jean-Toussaint Fieschi, Georges Alphonse Teppe, Fernand Cerceaux, Robert Guérin, Georges Leys, Fernand Ponsin
...
### Entorno cultural
La contratación de una misión francesa reflejaba la influencia cultural y militar de Francia en América Latina. Desde el siglo XIX, las élites venezolanas admiraban la cultura francesa. Tras la Primera Guerra Mundial, la reputación de la aviación francesa (con ases como René Fonck o Georges Guynemer) era indiscutible. Además, el agregado militar francés en Caracas había recomendado específicamente la aviación marítima para Venezuela, dado su extenso litoral.
...
- **Formación de los primeros pilotos militares venezolanos:** La misión francesa entrenó a la primera generación de aviadores venezolanos, entre ellos Juan Yépez, Antonio Villegas, Francisco Leonardi y otros once nombres documentados.
- **Adquisición de las primeras aeronaves:** Bajo la asesoría francesa, Venezuela adquirió sus primeros aviones: un Caudron G-3 monomotor (1920) y posteriormente los hidroaviones bimotores Caudron G-4 (1922), además de Farman F-40. También se incorporaron un Curtiss norteamericano, un Macchi italiano de 110 HP y un Salmson italiano de 220 HP.
- **Influencia en la organización militar:** La experiencia francesa influyó en la estructura, los procedimientos y la doctrina de la aviación militar venezolana durante sus primeros años.
- **Antecedente de futuras misiones:** Tras la partida de los instructores franceses (1929), Venezuela contrató misiones alemana (1930-1933) e italiana, que trajeron nuevos avances tecnológicos como los hidroaviones Junkers Bremen.
- **Raid internacional de 1930:** El hidroavión Junkers Bremen "Bolívar", heredero de la tradición aeronáutica iniciada por la misión francesa, realizó el primer vuelo internacional venezolano en la ruta Maracay-Maracaibo-Santa Marta (Colombia) para conmemorar el centenario de la muerte de Simón Bolívar.
