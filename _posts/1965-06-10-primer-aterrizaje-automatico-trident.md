---
layout: post
title: "10 de junio de 1965 | Primer aterrizaje automático de un avión comercial en vuelo regular"
date: 1965-06-10
categories: [evento]
author: Enrique Pomares
pais: Reino Unido
operator: British European Airways (BEA)
excerpt: "El 10 de junio de 1965, un Hawker Siddeley Trident 1C de British European Airways realizó el primer aterrizaje automático de la historia de la aviación comercial en vuelo regular con pasajeros, al tocar tierra en Londres-Heathrow procedente de París-Le Bourget."
image: 1965-06-10-primer-aterrizaje-automatico-trident.webp
---
...
- **Número de vuelo:** BE343
- **Aerolínea:** British European Airways (BEA), predecesora de British Airways
- **Aeronave:** Hawker Siddeley HS-121 Trident 1C
- **Matrícula:** G-ARPR
- **Ruta:** París-Le Bourget (LBG) → Londres-Heathrow (LHR)
- **Pasajeros:** 80
- **Piloto:** Capitán Eric Poole
- **Copiloto:** Tommy Atkins
- **Sistema de aterrizaje automático:** Autoflare / Autoland de Smiths Industries
- **Altura de activación del sistema:** 150 pies (45,7 m)
- **Altura de inicio del flare:** 65 pies (19,8 m)
- **Predecesor técnico:** Primer aterrizaje automático completo (sin pasajeros) el 5 de marzo de 1964 en el RAE Bedford por el Trident G-ARPB 
...
En 1965, los sistemas de aproximación instrumental (ILS) eran estándar, pero el piloto seguía siendo el único responsable del aterrizaje desde la toma de decisión hasta el contacto con la pista. El Reino Unido, a través del Royal Aircraft Establishment (RAE) en Bedford, había invertido años en investigación de sistemas de aterrizaje automático, consciente de que su climatología adversa le daba una ventaja competitiva frente a la industria estadounidense. El sistema Autoflare de Smiths Industries, con sus computadoras duplicadas que se monitorizaban mutuamente, representaba un salto cualitativo en la fiabilidad de los sistemas de control de vuelo.
...
- **1958:** BEA exige un avión más pequeño que el diseño original, lo que lleva a la configuración trireactor que daría nombre al Trident.

- **9 de enero de 1962:** Primer vuelo del prototipo Trident en Hatfield.

- **1 de abril de 1964:** El Trident entra en servicio regular de pasajeros con BEA en la ruta Londres-Zúrich-Niza.

- **5 de marzo de 1964:** El Trident 1C G-ARPB realiza el primer aterrizaje completamente automático de la historia en el RAE Bedford, sin pasajeros a bordo.

- **3 de junio de 1965:** La Air Registration Board británica certifica el sistema Autoflare para su uso en vuelos comerciales.

- **10 de junio de 1965:** El Trident 1C G-ARPR, operando el vuelo BE343 París-Le Bourget → Londres-Heathrow, realiza el primer aterrizaje automático en servicio regular con 80 pasajeros de pago.

- **4 de noviembre de 1966:** El Trident realiza el primer aterrizaje automático genuinamente «a ciegas» (sin visibilidad por niebla) en servicio regular.
...
- **Ventaja competitiva británica:** La tecnología Autoland de Smiths Industries dio a BEA y a la industria aeronáutica británica un liderazgo temporal sobre sus competidores estadounidenses en el campo de la fiabilidad operativa en condiciones adversas.

- **Reducción de cancelaciones:** El sistema permitía a BEA operar en condiciones de visibilidad reducida que antes forzaban el cierre del aeropuerto, mejorando significativamente la puntualidad invernal.
