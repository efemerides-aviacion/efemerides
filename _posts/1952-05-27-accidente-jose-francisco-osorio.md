...
- **Lugar:** Sector Los Guayos, estado Carabobo, Venezuela (entre Valencia y Guacara), durante maniobras en el norte de Morón y cercanías del Lago de Valencia
- **Unidad involucrada:** Escuadrón Aéreo de Caza Nro. 36 (Destacamento), Fuerza Aérea Venezolana
- **Aeronaves:** Dos De Havilland DH.100 Vampire FB.Mk.52 (colisionaron); una tercera aeronave regresó por fallas
- **Maniobra previa a la colisión:** "Loop" seguido de "tonel por la izquierda"
- **Fallecidos:** 
  - **Subteniente (AV) Francisco José Osorio** (piloto, ocupante único)
  - **Un agricultor en tierra** (electrocutado por un cable de alta tensión derribado durante el accidente)
- **Sobreviviente:** Subteniente (AV) Rafael Eduardo Jelambi Terán (se lanzó en paracaídas desde 7.000 pies, resultó herido)
- **Tercer piloto (regresó a la base):** Discrepancia entre fuentes (ver Nota aclaratoria)
- **Daños a las aeronaves:** Dos destruidas
...
- **Falla técnica:** Una de las aeronaves presenta fallas en el tren de aterrizaje (desplazamiento de una rueda), por lo que regresa de inmediato a la base.
- **Continuación del ejercicio:** Los otros dos pilotos continúan el programa de ejercicios programados. Realizan un "loop" seguido de un "tonel por la izquierda".
- **Colisión:** Durante la maniobra, la aeronave del Subteniente Osorio impacta contra la parte inferior del Vampire de Jelambi.
- **Consecuencias del impacto:** La aeronave de Osorio entra en barrena y comienza a caer. La aeronave de Jelambi también resulta dañada.
- **Abandono de las aeronaves:** Jelambi logra retirar la capota de su avión y lanzarse en paracaídas desde 7.000 pies de altura, aterrizando con heridas pero con vida. Osorio no logra salir de su aeronave.
...
Rafael Eduardo Jelambi Terán nació y se formó como piloto militar en Venezuela. Participaba activamente en las prácticas para formar el equipo acrobático de la FAV. Al sufrir la colisión, logró desprenderse de su Vampire y lanzarse en paracaídas desde 7.000 pies de altura, una proeza que lo convirtió en el **primer piloto en utilizar un paracaídas desde un avión a reacción en Venezuela**. A pesar de sus heridas, sobrevivió al accidente y continuó su carrera en la Fuerza Aérea. Alcanzó el rango de **General de Brigada** y falleció el 7 de octubre de 2016.

### Subteniente (AV) Agustín Antonio Berzares Morales (posible tercer piloto)
...
Nota: Según algunas fuentes, Berzares fue el tercer piloto que regresó a la base por fallas en el tren de aterrizaje. Otras fuentes más detalladas señalan que el tercer piloto fue Edgar Suárez Mier y Terán. Ver la Nota aclaratoria para más detalles sobre esta discrepancia.
...
<div class="note-box">
  ...
  <p><strong>2. Víctima en tierra:</strong> Según la base de datos de Aviation Safety Network, un agricultor en tierra murió electrocutado por un cable de alta tensión derribado durante el accidente.</p>
  ...
  <p><strong>4. Testimonio de Berzares:</strong> El relato del General de División Agustín Berzares Morales proviene de su libro "De Maracaibo a Persépolis" y aporta valioso contexto sobre los desafíos del entrenamiento en los primeros reactores.</p>
  <p><strong>5. Discrepancia sobre el tercer piloto:</strong> Las fuentes presentan una contradicción sobre la identidad del tercer piloto que regresó a la base por fallas mecánicas. El Cnel. (Av) José Ochoa Vargas y el G/D Agustín Berzares Morales señalan a Berzares como el tercer piloto. Sin embargo, el documento de Francisco Efraín Visconti Osorio (2023) indica que el tercer piloto fue Edgar Suárez Mier y Terán, quien reemplazó a Daniel Robayo a última hora, y que regresó por falla en la pierna izquierda del tren de aterrizaje. El documento de Visconti Osorio presenta una secuencia más detallada y estructurada. La efeméride presenta ambas versiones hasta que una fuente primaria adicional resuelva la discrepancia.</p>
  <p><strong>6. Altura del salto de Jelambi:</strong> Según Visconti Osorio, Jelambi se lanzó en paracaídas desde una altura de 7.000 pies.</p>
</div>
