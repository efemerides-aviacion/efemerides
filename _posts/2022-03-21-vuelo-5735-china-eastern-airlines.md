...
- **Designador de vuelo:** MU5735 / CES5735
- **Aeronave:** Boeing 737-89P (WL)
- **Matrícula:** B-1791
- **Número de serie (msn):** 41474 / 6139
- **Fabricación:** 7 de mayo de 2015
- **Horas de vuelo al momento:** 18.239 horas
- **Pasajeros:** 123
- **Tripulación:** 9 (3 pilotos, 6 auxiliares)
- **Personas a bordo:** 132
- **Víctimas mortales:** 132
...
China Eastern Airlines es una de las tres principales aerolíneas de China continental, con sede en Shanghái. Su flota de Boeing 737-800, uno de los modelos más utilizados en el mundo, ha mantenido históricamente un excelente registro de seguridad. El accidente del vuelo 5735 ocurrió en un momento de estricto control de la aviación civil china, que hasta entonces había acumulado más de 10 años sin accidentes fatales en vuelos comerciales regulares (el último había sido en 2010).

### Entorno social
China vivía en marzo de 2022 bajo estrictas medidas sanitarias derivadas de la política "Cero COVID", con restricciones de movilidad y cuarentenas. El accidente conmocionó a la opinión pública y al gobierno, que ordenó una investigación exhaustiva y la inspección de toda la flota de 737-800 en el país. Las familias de las víctimas enfrentaron además dificultades adicionales para desplazarse debido a las restricciones pandémicas.

### Entorno tecnológico
El Boeing 737-800 es un avión de pasillo único ampliamente probado, con más de 5.000 unidades entregadas desde finales de los años 90. La aeronave siniestrada, con apenas siete años de servicio, contaba con todos los sistemas de seguridad modernos, incluyendo registradores de vuelo digitales y sistema de alerta de proximidad al terreno (EGPWS). El análisis de los datos de vuelo sería crucial para entender la secuencia del accidente.
...
- **Marzo-abril de 2022:** China envía los registradores a los laboratorios de la Junta Nacional de Seguridad en el Transporte (NTSB) de Estados Unidos para su análisis y descarga de datos, en un gesto de cooperación técnica.
- **20 de abril de 2022:** La CAAC publica un informe preliminar que confirma los datos de vuelo pero no establece causas, limitándose a describir la trayectoria y descartar factores como meteorología adversa o fallos mecánicos evidentes.
- **2023-2024:** Fuentes no oficiales filtran que los datos del FDR sugieren una entrada de control intencional (push forward) en la columna de control, posiblemente realizada por el instructor o el capitán. La CAAC no confirma ni desmiente, alegando secreto de investigación.
- **15 de marzo de 2024:** Reuters informa que el informe final sigue sin publicarse y que fuentes cercanas a la investigación citan "sensibilidad nacional" como razón de la demora.
...
- **Debate sobre la transparencia:** Ha reabierto el debate sobre la publicación de informes de accidentes en países con restricciones a la información.
