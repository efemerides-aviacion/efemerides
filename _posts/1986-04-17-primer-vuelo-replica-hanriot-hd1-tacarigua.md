...
<figure>
  <img class="post-image" src="{{ site.baseurl }}/assets/img/1986-04-17-primer-vuelo-replica-hanriot-hd1-tacarigua.webp" alt="Hanriot HD.1 Tacarigua en vuelo">
...
- **Fecha del primer vuelo oficial:** 17 de abril de 1986
- **Lugar:** Base Aérea Mariscal Sucre (BASUCRE), Boca de Río, estado Aragua, Venezuela
- **Aeronave:** Hanriot HD-1-ET “Tacarigua” (réplica a escala real)
- **Piloto en el vuelo oficial:** General Cándido Farías
- **Constructor principal:** Escuela Técnica de la Fuerza Aérea Venezolana (FAV)
- **Director del proyecto:** Técnico aeronáutico Romano Remiddi
- **Origen de los planos:** Aeronautica Macchi (Italia), a partir de los planos originales del Hanriot HD.1 de 1916
- **Motor:** Lycoming de 150 hp
- **Materiales:** Madera y chapa de duraluminio
...
La Venezuela de los años ochenta vivía un período de bonanza petrolera que permitía inversiones en tecnología y formación. El gobierno y las fuerzas armadas promovían proyectos de “independencia tecnológica” que demostraran la capacidad del país para desarrollar sistemas complejos. La construcción de una réplica de un avión de 1916 utilizando técnicas artesanales y materiales locales se alineaba con este discurso.
...
<div class="references">
  <ul>
    <li><a href="https://www.aviacioncivil.com.ve/romano-remiddi-el-inmigrante-constructor-de-aviones-de-venezuela/">Aviación Civil - Romano Remiddi, el inmigrante constructor de aviones de Venezuela</a></li>
    <li><a href="https://commons.wikimedia.org/wiki/File:Avi%C3%B3n_Tacarigua.jpg">Wikimedia Commons - File: Avión Tacarigua.jpg</a></li>
    ...
    <li><a href="https://es.wikipedia.org/wiki/Hanriot_HD.1">Wikipedia - Hanriot HD.1</a></li>
    <li><a href="http://www.flugzeuginfo.net/acdata_php/acdata_hanriot_hd1_en.php">Flugzeuginfo - Technical Data / Description Hanriot HD.1</a></li>
    <li><a href="https://favclubven.wordpress.com/2024/12/19/el-hd-1et-tacarigua-la-replica-venezolana-de-un-legendario-caza/">El HD-1ET Tacarigua, la réplica venezolana de un legendario caza</a></li>
  </ul>
</div>
...
- **Timestamp de verificación:** 2026-04-15 08:00:00 UTC
