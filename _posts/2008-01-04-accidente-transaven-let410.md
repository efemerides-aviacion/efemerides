...
pais: Venezuela
operator: Transaven (Transporte Aéreo Venezolano)
excerpt: "El 4 de enero de 2008, el vuelo de Transaven entre Maiquetía y Los Roques sufrió una falla de ambos motores. El Let L-410 YV2081 se precipitó al mar Caribe con 14 ocupantes, todos fallecidos. Los restos fueron localizados cinco años después a 974 metros de profundidad."
image: 2008-01-04-accidente-transaven-let410.webp
---

<figure>
  <img class="post-image" src="{{ site.baseurl }}/assets/img/2008-01-04-accidente-transaven-let410.webp" alt="Avión Let L-410 de TRANSAVEN">
...
- **Matrícula:** YV2081
- **Número de serie (MSN):** 872015
- **Horas de vuelo totales:** 6.135 horas
- **Motores:** Walter M-601E
- **Operador:** Transaven (Transporte Aéreo Venezolano)
- **Tripulación:** 2 (piloto y copiloto)
- **Pasajeros:** 12
- **Total ocupantes:** 14
- **Víctimas mortales:** 14
- **Supervivientes:** 0
- **Piloto:** Esteban Bessil (venezolano)
- **Copiloto:** Osmel Alfredo Avila Otamendi, 37 años (venezolano)
- **Nacionalidad de los pasajeros:** 8 italianos, 3 venezolanos, 1 suizo
- **Fase del vuelo:** Crucero inicial / descenso (aproximadamente 25-30 minutos después del despegue)
- **Causa oficial:** Falla de ambos motores; informe final sin declaración de "Causa Probable"
- **Investigación:** JIAAC Venezuela (Junta Investigadora de Accidentes de Aviación Civil)
...
- **09:38 (25 minutos de vuelo):** El piloto Esteban Bessil reporta a la torre de control de Los Roques que ambos motores han fallado y que se encuentra a 3.000 pies (910 m) de altitud, a 16 millas náuticas (30 km) de la costa. Anuncia que intentará amarizar lo más cerca posible del archipiélago.
- **09:42:** Se pierde el contacto radial y el avión desaparece del radar.
- **4 de enero (tarde):** Otro Let L-410 de Transaven sobrevuela el área del presunto accidente. Solo encuentra una mancha de líquido en la superficie del agua (probablemente aceite o combustible) que se disipa rápidamente.
- **12 de enero de 2008:** Pescadores encuentran el cuerpo de un hombre a 12 km de la costa del estado Falcón (península de Paraguaná). La autopsia confirma que se trata del copiloto Osmel Alfredo Avila Otamendi, de 37 años. También se recupera su chaleco salvavidas.
- **Abril de 2008:** Un buque de la Armada venezolana, utilizando sonar, identifica un posible resto de aeronave a 300 metros de profundidad. Meses después se recuperan los restos, pero no pertenecen al YV2081.
...
- **Debilidades en los protocolos de búsqueda:** La desaparición del avión evidenció carencias en los sistemas de búsqueda y salvamento (SAR) venezolanos. El hallazgo del fuselaje solo fue posible cinco años después gracias a un buque estadounidense.
- **Tensiones diplomáticas:** El gobierno italiano presionó para que se investigara el accidente, especialmente por la alta cantidad de víctimas italianas. Se denunció que las autoridades venezolanas rechazaron inicialmente la ayuda internacional, retrasando las búsquedas.
