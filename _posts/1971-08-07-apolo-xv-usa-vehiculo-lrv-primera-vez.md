---
layout: post
title: "7 de agosto de 1971 | Concluye el Apolo 15, la misión que estrenó el vehículo lunar"
date: 1971-08-07
categories: [espacial]
author: Enrique Pomares
pais: Estados Unidos
operator: NASA
excerpt: "Scott e Irwin recorrieron 27,9 kilómetros por Hadley-Apenino a bordo del primer vehículo con ruedas que operó fuera de la Tierra."
image: 1971-08-07-apolo-xv-usa-vehiculo-lrv-primera-vez.webp
---
...
En el verano de 1971, el interés público por las misiones lunares había decaído de manera acusada. <a href="https://efemerides-aviacion.github.io/efemerides/espacial/1969/07/20/alunizaje-apolo11.html" style="color: #315fea; text-decoration: none;">El alunizaje del Apolo 11</a>, dos años antes, había concentrado una audiencia sin precedentes, pero la repetición del logro fue restando espectacularidad a cada misión sucesiva. El Congreso recortaba presupuestos y ya se habían cancelado vuelos previstos. En ese clima, la NASA necesitaba demostrar que las misiones restantes producían conocimiento y no solo imágenes, y el vehículo lunar ofrecía además un elemento visualmente atractivo: por primera vez se veía a un ser humano conducir sobre otro mundo.

### Entorno tecnológico

Las tres primeras misiones de alunizaje habían operado con una limitación severa: los astronautas no podían alejarse más de un kilómetro escaso del módulo lunar, porque en caso de avería del sistema de soporte vital debían poder regresar caminando con la reserva de oxígeno disponible. Esa restricción confinaba la exploración a las inmediaciones del punto de descenso. El vehículo elevó el radio operativo hasta unos diez kilómetros y transformó la naturaleza de las misiones: permitía alcanzar formaciones distintas, transportar instrumental pesado y volver cargado de muestras. Su diseño hubo de resolver problemas inéditos, desde ruedas de malla metálica capaces de rodar sobre polvo abrasivo en vacío hasta un sistema de navegación por estima que calculaba en todo momento el rumbo de regreso al módulo, sin referencias magnéticas ni satélites.
...
- **26 de julio de 1971, 13:34:00 UTC:** despega el Saturn V SA-510 desde la plataforma 39A del Centro Espacial Kennedy.
- **30 de julio de 1971, 22:16:29 UTC:** el módulo lunar *Falcon* se posa en Hadley-Apenino, con Scott e Irwin a bordo. Worden permanece en órbita en el *Endeavour*.
- **30 de julio de 1971:** Scott realiza una salida de reconocimiento desde la escotilla superior del módulo para examinar el terreno circundante.
- **31 de julio de 1971:** primera salida a la superficie. Scott e Irwin despliegan el vehículo lunar desde su alojamiento en el costado del módulo mediante un sistema de poleas y cuerdas, y efectúan el primer recorrido motorizado sobre otro cuerpo celeste. La dirección delantera no responde y conducen gobernando con las ruedas traseras.
- **1 de agosto de 1971:** segunda salida, la más larga de la misión. La dirección delantera vuelve a funcionar. Se recoge la muestra que se conocerá como Roca Génesis.
- **2 de agosto de 1971:** tercera salida. Antes de concluirla, Scott efectúa ante las cámaras el experimento del martillo y la pluma.
- **2 de agosto de 1971, 17:11:23 UTC:** el *Falcon* despega de la superficie lunar. El vehículo queda abandonado en Hadley, orientado para transmitir la partida.
- **2 de agosto de 1971, 19:10:25 UTC:** acoplamiento del módulo lunar con el *Endeavour*.
- **4 de agosto de 1971:** tras completar setenta y cuatro órbitas lunares y liberar un subsatélite científico, el motor principal se enciende para iniciar el regreso.
- **5 de agosto de 1971:** Worden sale al espacio durante 39 minutos para recuperar los casetes de película del compartimento de instrumentos, en la primera actividad extravehicular realizada lejos de la órbita terrestre.
...
Su descendencia directa no es tripulada, pero comparte el mismo principio: extender el alcance de la exploración más allá del punto de llegada. Los vehículos automáticos que recorren Marte desde hace décadas resuelven, con otra tecnología y sin tripulación, el problema que el Lunar Roving Vehicle planteó por primera vez. La <a href="https://efemerides-aviacion.github.io/efemerides/espacial/1976/07/20/viking1-sonda-espacial-en-marte.html" style="color: #315fea; text-decoration: none;">sonda Viking 1, que se posó en Marte cinco años después</a>, todavía era estática; la movilidad superficial en otro planeta tardaría dos décadas más en llegar.
