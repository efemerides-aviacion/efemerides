---
layout: post
title: "1 de julio de 1935 | Récord mundial de resistencia aérea de los hermanos Key"
date: 1935-07-01
categories: [evento]
author: Enrique Pomares
pais: Estados Unidos
operator: Aero Club de America
excerpt: "El 1 de julio de 1935, los hermanos Al y Fred Key establecieron el récord mundial absoluto de resistencia aérea sin escalas de 653 horas y 34 minutos a bordo del Curtiss Robin 'Ole Miss'."
image: 1935-07-01-record-endurance-fred-al-key-curtiss-robin.webp
...
- **Consumo logístico en el aire:** 6.000 galones (22.712 litros) de gasolina y 300 galones (1.135 litros) de aceite lubricante transferidos en pleno vuelo
- **Hito de distancia estimada:** Trayectoria total aproximada de 52.320 millas (84.200 km), una distancia superior a dos vueltas completas al planeta Tierra
- **Innovación del acoplamiento seguro:** Válvula de corte automático de combustible diseñada por el mecánico local A. D. Hunter para impedir derrames sobre el escape caliente, tecnología adoptada posteriormente por el Cuerpo Aéreo del Ejército de los EE. UU.
- **Modificaciones estructurales extremas:** Pasarela lateral instalada para permitir que Fred Key saliera de la cabina y realizara el mantenimiento y engrase del motor en pleno vuelo
- **Métricas de la tripulación en vuelo:** Los hermanos alternaban turnos de pilotaje y descanso, durmiendo en un saco sobre un tanque auxiliar de combustible instalado en la parte trasera de la cabina
...
### Entorno social
La sociedad estadounidense de 1935 seguía con enorme expectación los récords de permanencia en el aire, percibiendo a los pilotos como titanes que expandían las fronteras de lo posible. En la pequeña comunidad de Meridian, Mississippi, el ayuntamiento planeaba arar las pistas de su aeropuerto municipal para sembrar algodón, lo que motivó a los hermanos Key a realizar un hito sin precedentes para salvar el aeródromo local.

### Entorno tecnológico
En el plano de la ingeniería de vuelo, los sistemas de reabastecimiento aéreo de la época eran extremadamente peligrosos debido al riesgo de incendios catastróficos por derrames de gasolina sobre los escapes del motor. La transición técnica hacia sistemas herméticos requirió de la inventiva de mecánicos y soldadores de taller, quienes desarrollaron los primeros acoplamientos y válvulas de desconexión rápida que sentaron las bases de la seguridad aérea.
...
- **1934:** Los hermanos Al y Fred Key, administradores del aeropuerto de Meridian, comienzan a diseñar un plan para batir el récord de resistencia aérea de 553 horas en manos de los hermanos Hunter de Chicago.
- **Principios de 1935:** El mecánico local A. D. Hunter fabrica un sistema de boquilla de reabastecimiento con corte automático, y se instala una pasarela metálica exterior en el fuselaje del Curtiss Robin.
- **4 de junio de 1935 (04:00 horas aprox.):** Los hermanos Key despegan con éxito de Meridian, Mississippi, a bordo del Curtiss Robin J-1 «Ole Miss», iniciando su histórica órbita sobre el municipio.
- **Junio de 1935:** La tripulación completa con éxito un promedio de quince reabastecimientos diarios de comida, agua y combustible mediante un avión nodriza que bajaba los suministros en una cuerda.
...
- **Estandarización de la boquilla de reabastecimiento:** La innovadora boquilla libre de derrames diseñada por A. D. Hunter para el vuelo del «Ole Miss» fue adoptada de inmediato por el Cuerpo Aéreo del Ejército de los Estados Unidos (U.S. Army Air Corps), sentando las bases para el desarrollo de la aviación estratégica de largo alcance de la Segunda Guerra Mundial y de la posguerra.
- **Salvación de la infraestructura local:** El éxito masivo del vuelo atrajo tal cantidad de publicidad y recursos que el ayuntamiento de Meridian canceló los planes de clausurar el aeropuerto municipal, el cual fue rebautizado con orgullo como *Key Field* en honor a los hermanos héroes.
...
<div class="references">
  <ul>
    <li><a href="https://airandspace.si.edu/collection-archive/al-and-fred-key-ole-miss-endurance-record-certificate/sova-nasm-xxxx-0879" style="color: #315fea; text-decoration: none;">Smithsonian Institution – Al and Fred Key Ole Miss Endurance Record Certificate</a></li>
    <li><a href="https://en.wikipedia.org/wiki/The_Flying_Keys" style="color: #315fea; text-decoration: none;">Wikipedia (EN) – History and feats of the Flying Keys</a></li>
    <li><a href="https://www.meridianstar.com/opinion/columns/a-meridian-moment-in-time/article_d2a48091-717f-53a8-a66a-ac68c227f4bc.html" style="color: #315fea; text-decoration: none;">Meridian Star – A Meridian Moment in Time: The Story of Ole Miss</a></li>
    <li><a href="https://www.meridianairport.com/keybrothersaviationmuseum" style="color: #315fea; text-decoration: none;">Meridian Regional Airport – Preserving the History of The Key Brothers</a></li>
  </ul>
</div>
