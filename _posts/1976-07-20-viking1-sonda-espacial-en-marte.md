---
layout: post
title: "20 de julio de 1976 | Viking 1: Primer aterrizaje exitoso y misión de larga duración en Marte"
date: 1976-07-20
categories: [espacial]
author: Enrique Pomares
pais: Estados Unidos
operator: NASA / JPL
excerpt: "La sonda norteamericana Viking 1 se convierte en la primera nave en lograr un aterrizaje exitoso y operativo de larga duración en Marte, transmitiendo la primera imagen de la superficie marciana desde Chryse Planitia."
image: 1976-07-20-viking1-sonda-espacial-en-marte.webp
---

<figure>
  <img class="post-image" src="{{ site.baseurl }}/assets/img/1976-07-20-viking1-sonda-espacial-en-marte.webp" alt="Primera fotografía obtenida desde la superficie de Marte por el módulo de aterrizaje Viking 1 mostrando las rocas marcianas y parte del soporte del pie de la sonda">
...
<p>El 20 de julio de 1976, la sonda espacial Viking 1 de la NASA hizo historia al completar con éxito el primer posado controlado, completamente operativo y de larga duración sobre la superficie del planeta Marte. A las 11:53:06 UTC, el módulo de aterrizaje (<em>lander</em>) se posó suavemente en la región de Chryse Planitia (Llanura Dorada). Apenas 25 segundos después del contacto con el suelo, la sonda comenzó a transmitir la primera imagen fotográfica jamás tomada desde la superficie marciana, mostrando rocas, regolito y una de las patas de apoyo del propio vehículo.</p>
...
- **Lugar de aterrizaje:** Chryse Planitia (Llanura Dorada), Marte (coordenadas 22,48° N, 47,97° O).
- **Misión / Sonda:** Viking 1 (integrada por un orbitador y un módulo de aterrizaje).
- **Operador:** NASA / Jet Propulsion Laboratory (JPL).
- **Lanzamiento inicial:** 20 de agosto de 1975 desde Cabo Cañaveral, Florida (cohete Titan IIIE-Centaur).
- **Entrada en órbita marciana:** 19 de junio de 1976.
- **Transmisión de la primera imagen:** 20 de julio de 1976 (25 segundos después del aterrizaje).
...
### Entorno social
Tras la conclusión del programa Apolo y los alunizajes tripulados en la Luna, el interés público y gubernamental estadounidense viró hacia el estudio científico continuo de los planetas vecinos. El lanzamiento y llegada de la Viking 1 formaron parte integral de los festejos por el Bicentenario de los Estados Unidos (1776–1976). Aunque el aterrizaje previsto originalmente para el 4 de julio tuvo que posponerse para evaluar minuciosamente el relieve rocoso de la zona de descenso, la confirmación del éxito el 20 de julio —coincidiendo exactamente con el séptimo aniversario del alunizaje del Apolo 11— causó un profundo impacto patriótico y científico en la sociedad norteamericana.

### Entorno tecnológico
A mediados de la década de 1970, el descenso atmosférico en Marte representaba uno de los desafíos de ingeniería más complejos jamás afrontados. La delgada atmósfera marciana (menos del 1 % de la presión terrestre) resultaba insuficiente para frenar únicamente con paracaídas, pero lo bastante densa como para generar un intenso calentamiento por fricción. La Viking 1 incorporó un escudo térmico de protección, un paracaídas desacelerador supersónico y un sistema de tres retrocohetes de empuje variable impulsados por hidracina monopropulsante, guiados por un radar altímetro de alta precisión y computadoras de a bordo capaces de tomar decisiones de descenso en tiempo real.
...
- **20 de agosto de 1975:** Lanzamiento de la sonda Viking 1 a bordo de un cohete Titan IIIE-Centaur desde el Complejo de Lanzamiento 41 de Cabo Cañaveral.
- **19 de junio de 1976:** Inserción exitosa de la combinación orbitador-módulo de aterrizaje en órbita alrededor de Marte, iniciando el mapeo fotográfico para evaluar el sitio de descenso.
- **20 de julio de 1976 (08:51 UTC):** Separación del módulo de aterrizaje (*lander*) respecto al orbitador e inicio de la maniobra de desórbita.
- **20 de julio de 1976 (11:48 UTC):** Entrada en la atmósfera superior marciana a una velocidad aproximada de 16.000 km/h, protegida por el escudo térmico ablativo.
- **20 de julio de 1976 (11:52 UTC):** Despliegue del paracaídas de 16 metros de diámetro a 6,4 km de altitud, seguido del desprendimiento del escudo térmico.
- **20 de julio de 1976 (11:53:06 UTC):** Encendido de los tres retrocohetes de hidracina a 1,5 km de altura y posado suave en Chryse Planitia a una velocidad final de apenas 2,4 m/s.
- **20 de julio de 1976 (11:53:31 UTC):** Transmisión de la primera imagen de la superficie marciana (PIA00381), recibida con júbilo en el Centro de Control de Misiones del JPL en Pasadena, California.
