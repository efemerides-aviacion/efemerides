---
layout: post
title: "2 de agosto de 1917 | El primer apontaje de la historia en un buque en movimiento"
date: 1917-08-02
categories: [evento]
author: Enrique Pomares
pais: Reino Unido
operator: Royal Naval Air Service (RNAS)
excerpt: "El Squadron Commander Edwin Harris Dunning posó un Sopwith Pup sobre la cubierta del HMS Furious en Scapa Flow y logró el primer aterrizaje de la historia sobre un buque en navegación."
image: 1917-08-02-primer-apontaje-buque-movimiento.webp
---
...
<p>El 2 de agosto de 1917, en las aguas de Scapa Flow (Islas Orcadas, Escocia), el Squadron Commander Edwin Harris Dunning, del Royal Naval Air Service, logró posar un caza Sopwith Pup sobre la corta cubierta de vuelo de proa del HMS <em>Furious</em> mientras el buque navegaba a toda máquina. Fue la primera vez que una aeronave de ala fija se posaba sobre un buque en movimiento, un umbral técnico que hasta entonces se consideraba prácticamente inalcanzable.</p>
...
- **Fecha:** 2 de agosto de 1917.
- **Lugar:** Scapa Flow, Islas Orcadas, Escocia (Reino Unido).
- **Protagonista:** Squadron Commander Edwin Harris Dunning, DSC (17 de julio de 1892 – 7 de agosto de 1917), Royal Naval Air Service.
- **Aeronave:** caza biplano Sopwith Pup; las fuentes especializadas identifican el aparato como el N6453, construido por Beardmore.
- **Buque:** HMS <em>Furious</em>, crucero de batalla de la clase <em>Courageous</em> modificado durante su construcción, con hangar y cubierta de vuelo a proa en sustitución de la torre delantera. Botado el 18 de agosto de 1916 y entregado el 26 de junio de 1917.
- **Cubierta empleada:** plataforma de despegue de proa de unos 160 pies (49 metros), situada por delante del puente y la chimenea.
- **Condiciones de la maniobra:** buque navegando a 26 nudos (unos 48 km/h) contra un viento de 21 nudos (unos 39 km/h); la velocidad resultante sobre cubierta se redujo a unos pocos kilómetros por hora.
...
El apontaje de Dunning no fue una ocurrencia aislada, sino el punto de llegada de una década de tanteos entre la Marina y la aeronáutica en plena Primera Guerra Mundial, cuando la amenaza de los zepelines y la necesidad de vigilancia sobre el Mar del Norte presionaban por soluciones nuevas.

### Entorno social

La Royal Navy de 1917 era una institución jerárquica y profundamente conservadora, orgullosa de su tradición artillera. La idea de subordinar la línea de combate a un puñado de aparatos de madera y tela resultaba difícil de aceptar para buena parte del cuerpo de oficiales. Al mismo tiempo, la guerra había normalizado el riesgo experimental: una generación joven de aviadores navales, formada en los colegios navales de Osborne y Dartmouth y curtida en escenarios como Galípoli, asumía como propio el deber de probar en persona lo que se pedía a otros. Dunning, condecorado con la Distinguished Service Cross en marzo de 1916 por su labor como piloto de hidroavión, encarnaba con exactitud ese perfil.

### Entorno tecnológico

El estado del arte imponía límites severos. Los aviones carecían de frenos y de gancho de apontaje; los buques no disponían de cables transversales de detención ni de espejos ópticos de aproximación. El HMS <em>Furious</em> tampoco era un portaaviones en sentido estricto: conservaba su superestructura central, su chimenea y, en aquel momento, la torre artillera de popa, de modo que cualquier intento de aterrizaje obligaba a rodear el conjunto y a insertarse lateralmente sobre una plataforma muy corta. El Sopwith Pup, en cambio, jugaba a favor: ligero, de baja carga alar y velocidad de pérdida reducida, era uno de los pocos cazas capaces de sostenerse casi inmóvil respecto a la cubierta con viento suficiente de proa.
...
La secuencia de hitos que enmarca el apontaje permite situarlo en su lugar exacto dentro de la carrera por operar aeronaves desde buques de guerra.

- **14 de noviembre de 1910:** el civil estadounidense <a href="https://en.wikipedia.org/wiki/Eugene_Burton_Ely" style="color: #315fea; text-decoration: none;">Eugene Ely</a> despega de una plataforma instalada en el crucero USS <em>Birmingham</em>, fondeado.
- **18 de enero de 1911:** Ely aterriza sobre una plataforma del USS <em>Pennsylvania</em>, también con el buque detenido, empleando un rudimentario sistema de cabos lastrados.
...
Un siglo después, la maniobra de Scapa Flow se lee como el acto fundacional práctico de la aviación embarcada.

De la experiencia acumulada en el <em>Furious</em> derivan los rasgos que definirían al portaaviones moderno: cubierta continua sin obstáculos, ausencia de superestructura en el eje de aproximación o su desplazamiento a un costado, y sistemas de detención concebidos para dominar la energía del aparato en lugar de confiarla a la fuerza de la tripulación. El HMS <em>Argus</em>, entregado en 1918 con cubierta corrida, materializó ese aprendizaje casi de inmediato.

La Royal Navy institucionalizó la memoria del piloto mediante la Dunning Cup, entregada anualmente al oficial que más haya contribuido al progreso de la aviación naval. En 1992 se descubrió una piedra conmemorativa en Swanbister Bay, en las Orcadas, y el 2 de agosto de 2017, en el centenario exacto del vuelo, se inauguró una nueva placa en Scapa con la presencia del portaaviones HMS <em>Queen Elizabeth</em> fondeado en la bahía y un vuelo rasante de un Hawk T Mk 1 del 736 Naval Air Squadron que simuló una aproximación de apontaje.
