---
layout: post
title: "1 de julio de 1931 | Primera circunnavegación aérea del globo en monoplano monomotor"
date: 1931-07-01
categories: [evento]
author: Enrique Pomares
pais: Estados Unidos
operator: Aero Club de America
excerpt: "El 1 de julio de 1931, el piloto Wiley Post y el navegante Harold Gatty completaron la primera circunnavegación del globo en un monoplano monomotor, el Lockheed Vega 5C 'Winnie Mae'."
image: 1931-07-01-circunnavegacion-wiley-post-harold-gatty.webp

---

<figure>
  <img class="post-image" src="{{ site.baseurl }}/assets/img/1931-07-01-circunnavegacion-wiley-post-harold-gatty.webp" alt="Wiley Post y Harold Gatty celebrados en Nueva York">
...
- **Reparaciones críticas en ruta:** Reparación de la hélice en la playa de Nome, Alaska, y posterior sustitución por una de repuesto en Fairbanks para reanudar el vuelo
- **Instrumentación de cabina avanzada:** Cockpit modificado como "laboratorio volante", incorporando horizonte artificial Sperry, giroscopio direccional, brújula aperiódica y el indicador de deriva diseñado por Gatty (*Gatty Drift Indicator*)
- **Limitaciones de vuelo operativas:** Travesía realizada de manera analógica sin piloto automático, sin radio de comunicación de navegación y sin radiobalizas de guiado en tierra
...
A principios de la década de 1930, la aviación comercial internacional y de exploración buscaba superar los límites de la velocidad y el alcance de las aeronaves. El récord de circunnavegación aérea pertenecía desde 1929 al gigantesco dirigible alemán Graf Zeppelin, por lo que la comunidad aeronáutica internacional miraba con escepticismo la posibilidad de que un pequeño avión monomotor pudiera emular tal hazaña en una fracción de tiempo.

### Entorno social
La sociedad mundial de la Gran Depresión de 1931 seguía con fervor las hazañas de los pilotos que desafiaban la muerte sobre los océanos del planeta, buscando en estos hitos de valor un respiro frente a la crisis económica. El vuelo de Post y Gatty fue patrocinado por el rico petrolero F. C. Hall de Oklahoma, convirtiéndose en un poderoso símbolo del optimismo y el empuje empresarial de la época.

### Entorno tecnológico
En el plano técnico, el Lockheed Vega representó el apogeo de los aviones de ala alta construidos con fuselaje monocasco de madera multilaminada, que ofrecían un diseño aerodinámico excepcional. El Winnie Mae fue equipado de forma especial con la instrumentación nocturna y de vuelo ciego más avanzada de la época, convirtiéndose en un auténtico laboratorio volante para validar nuevas tecnologías de navegación instrumental.
...
- **23 de junio de 1931 (04:47 hora local):** El Winnie Mae despega de la pista de Roosevelt Field en Long Island, Nueva York, cargado al límite de su peso máximo, cruzando con éxito sobre Terranova hacia el Atlántico Norte.
- **24 de junio de 1931:** Tras un cruce de dieciséis horas en condiciones de lluvia y niebla, aterriza en el campo de Sealand de la RAF cerca de Liverpool, Inglaterra, y horas más tarde llega a Hannover, Alemania.
- **25 de junio de 1931:** El avión aterriza en el famoso Aeropuerto de Tempelhof en Berlín, y pocas horas más tarde arriba a Moscú, Unión Soviética, completando un tercio de la circunnavegación en menos de dos días.
- **26 de junio de 1931:** Los aviadores cruzan la inmensidad de la estepa siberiana bajo fuertes tormentas de lluvia, realizando una escala técnica para reabastecerse de combustible en Novosibirsk.
- **27 de junio de 1931:** El Winnie Mae arriba a Irkutsk para recibir mantenimiento básico y reabastecimiento tras sobrevolar las desoladas cordilleras de Siberia.
- **28 de junio de 1931:** La tripulación alcanza Jabárovsk, el último punto antes de encarar el salto transpacífico hacia Alaska a través de la isla de Sajalín.
- **29 de junio de 1931:** Post realiza un aterrizaje de emergencia en la playa de Cape Nome, Alaska, donde la hélice de acero resulta dañada en el barro; la tripulación y los mineros locales logran enderezarla a golpes para poder volar hacia Fairbanks.
...
- **Validación del sistema de navegación Weems:** El vuelo probó en las condiciones más extremas de visibilidad nula el valor del sistema de navegación astronómica Weems y el indicador de deriva inventado por Gatty, sentando las bases para el posterior desarrollo de las rutas aéreas militares y comerciales del Pacífico.
...
- **Exposición en el Smithsonian:** El legendario Lockheed Vega 5C *Winnie Mae* se conserva en perfecto estado de exhibición permanente en el Museo Nacional del Aire y el Espacio del Smithsonian en Washington D. C., siendo uno de los mayores atractivos históricos para investigadores y visitantes de todas las nacionalidades.
