---
layout: post
title: "30 de junio de 1968 | Primer vuelo del Lockheed C-5 Galaxy, el gigante del transporte estratégico"
date: 1968-06-30
categories: [evento]
author: Enrique Pomares
pais: Estados Unidos
operator: USAF
excerpt: "El 30 de junio de 1968, la mítica aeronave de transporte pesado Lockheed C-5 Galaxy realizó su primer vuelo en Marietta, Georgia, consagrándose como el mayor coloso a reacción militar de la época."
image: 1968-06-30-primer-vuelo-c-5-galaxy.webp
...
- **Peso de despegue en el primer vuelo:** 497.000 libras (225.435 kg)
- **Rendimiento del despegue:** Carrera de despegue de 3.800 pies (1.158 metros) alcanzando la rotación a una velocidad de 123 nudos (228 km/h)
- **Planta motriz real:** Cuatro motores turbofán de alto índice de derivación General Electric TF39-GE-1C, que producían una potencia de empuje unitaria de 41.000 libras (182 kN) para un empuje combinado de 164.000 lbf (730 kN)
- **Dimensiones físicas colosales:** Longitud de 75,54 metros, envergadura de 67,89 metros y una altura máxima de 19,84 metros en la cola tipo T
- **Capacidad de carga útil máxima:** 270.000 libras (122.470 kg) en configuraciones operativas estándar
...
- **Diciembre de 1965:** El Departamento de Defensa de los Estados Unidos adjudica formalmente a Lockheed-Georgia el contrato para la fabricación del fuselaje del nuevo avión de transporte pesado C-5A, y a General Electric el contrato de los revolucionarios motores TF39.
- **Agosto de 1966:** Comienza la construcción y el ensamblaje de las primeras piezas del prototipo C-5A en la gigantesca planta industrial de Lockheed en Marietta, Georgia.
- **2 de marzo de 1968:** Se realiza la ceremonia oficial de presentación pública (*Rollout*) del primer C-5A (número de serie 66-8303), con la asistencia del presidente Lyndon B. Johnson.
- **Junio de 1968:** El primer prototipo inicia las exigentes pruebas de rodaje a alta velocidad y frenado en pista, preparándolo para su primer despegue.
- **30 de junio de 1968 (07:47 EDT):** Bajo el indicativo radial «eight-three-oh-three heavy», el piloto Leo Sullivan eleva el coloso por primera vez, completando un vuelo inaugural de noventa y cuatro minutos sin contratiempos mecánicos.
- **Julio de 1969:** Se produce un fallo estructural prematuro en los ensayos estáticos de tierra cuando las alas del prototipo ceden al alcanzar el 84% de la carga de diseño, lo que desata una severa controversia política y financiera sobre la integridad de las alas del C-5A.
...
- **Revolución logística de la USAF:** El C-5 Galaxy dotó a los Estados Unidos de una capacidad de puente aéreo sin igual en la historia, permitiendo el envío de divisiones enteras del Ejército con sus tanques M60 Patton (y posteriormente M1 Abrams) de costa a costa en pocas horas.
- **Desarrollo de los motores de alta derivación:** La exitosa validación de los motores General Electric TF39 aceleró el desarrollo comercial de los turbofáns de alta derivación, lo que permitió a General Electric diseñar la familia de motores CF6 que propulsaría a aviones comerciales gigantes como el Boeing 747, el McDonnell Douglas DC-10 y el Airbus A300.
...
- **El coloso activo de la USAF:** Con la modernización a la versión C-5M Super Galaxy (completada con la de nuevos motores CF6 y aviónica digital avanzada), el Galaxy se proyecta para seguir en servicio activo más allá del año 2040, acumulando una vida útil extraordinaria de más de setenta años de operaciones.
