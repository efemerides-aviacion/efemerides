---
layout: post
title: "31 de enero de 1923 | Primer vuelo en circuito cerrado del autogiro Cierva C.4"
date: 1923-01-31
categories: [evento]
...
<figure>
  <img class="post-image" src="{{ site.baseurl }}/assets/img/1923-01-31-primer-circuito-cerrado-autogiro-c-4.webp" alt="El autogiro Cierva C.4 en vuelo bajo durante las pruebas de enero de 1923 en Getafe">
  <figcaption class="post-caption">El autogiro Cierva C.4 en vuelo bajo durante las pruebas de enero de 1923 en el aeródromo de Getafe. El aparato utilizaba el fuselaje de un monoplano Sommer y un motor rotativo Le Rhône, con un rotor de cuatro palas articuladas ideado por Juan de la Cierva. Fotografía de época, dominio público.</figcaption>
</figure>
...
- **Número de vuelos en la sesión:** tres, el último de los cuales corresponde al circuito cerrado.
...
La clave del C.4 fue la **bisagra de batimiento**. En un rotor que avanza, la pala que se mueve en el sentido de la marcha tiene más velocidad relativa que la que retrocede, y por tanto genera más sustentación, lo que había volcado a los prototipos anteriores. Cierva resolvió el problema permitiendo que cada pala se moviese libremente hacia arriba y abajo en su arranque: la pala avanzante subía, reducía su ángulo de ataque y su sustentación; la pala retrocedente bajaba, aumentaba su ataque y la recuperaba, igualando el disco del rotor. Era la primera articulación funcional de rotor de la historia y, al mismo tiempo, la demostración experimental del principio de autorrotación.

El aparato se apoyó en las instalaciones del Laboratorio Aerodinámico de Cuatro Vientos, que el propio Emilio Herrera había puesto en servicio y que por entonces contaba con uno de los mejores túneles de viento de circuito cerrado de Europa.

### Entorno cultural

El autogiro apareció en la prensa de todo el mundo como un «paracaídas automático» y un aparato «que no podía entrar en pérdida». Para un país que aún no contaba con una industria aeronáutica propia, ver un invento español a la cabeza de la técnica aérea supuso un impacto notable. El rey Alfonso XIII, que se fotografió con el aparato meses después, llegó a volar como pasajero en versiones posteriores.

<hr style="margin: 2rem 0; border: none; height: 2px; background: linear-gradient(to right, #1565c0, #42a5f5);">

## Desarrollo Cronológico

- **1919:** accidente del bombardero trimotor de Cierva, pilotado por Julio Ríos Agüeso. El ingeniero inicia la búsqueda de un aparato más seguro.
...
<div class="references">
  <ul>
    <li>Herrera Linares, Emilio. Certificado oficial del vuelo del autogiro Cierva C.4, Cuatro Vientos, 1 de febrero de 1923. Reproducido en García Merayo, Félix, «El autogiro de Juan de la Cierva», <em>Acta</em>. <a href="https://www.acta.es/medios/articulos/ciencias_y_tecnologia/171001.pdf" style="color: #315fea; text-decoration: none;">Acta</a></li>
    <li>National Air and Space Museum, Smithsonian Institution. Ficha del Cierva C.8W (cat. A19320006000). <a href="https://airandspace.si.edu/collection-objects/cierva-c8w-c8l-mk-iv/nasm_A19320006000" style="color: #315fea; text-decoration: none;">Smithsonian</a></li>
    <li>Ejército del Aire y del Espacio / Museo del Aire. Ficha del Cierva C.19 Mk.IV (inventario MAA-1141). <a href="https://ejercitodelaireydelespacio.defensa.gob.es/EA/museodelaire/actividades/pieza/2026-1S.pdf" style="color: #315fea; text-decoration: none;">Museo del Aire</a></li>
    <li>Centenario del Autogiro. «The autogiro history», sitio conmemorativo del centenario del primer vuelo (Getafe, 1923-2023). <a href="https://centenarioautogiro.com/en/the-autogiro-history/" style="color: #315fea; text-decoration: none;">Centenario Autogiro</a></li>
    <li>Real Academia de la Historia. Adolfo Roldán, «Juan de la Cierva y Codorníu», <em>Diccionario Biográfico Español</em>. <a href="https://dbe.rah.es/biografias/10223/juan-de-la-cierva-y-codorniu" style="color: #315fea; text-decoration: none;">RAH</a></li>
    <li>Wikipedia. «Cierva C.4». <a href="https://en.wikipedia.org/wiki/Cierva_C.4" style="color: #315fea; text-decoration: none;">Wikipedia (EN)</a></li>
    <li>Asociación de Cronistas del Aire y del Mar (ACAMI). «9 de enero de 1923: primer vuelo en autogiro en el aeródromo de Getafe». <a href="https://www.acami.es/efemerides/9-de-enero-de-1923juan-de-la-cierva-realiza-el-primer-vuelo-en-autogiro-en-el-aerodromo-de-getafe/" style="color: #315fea; text-decoration: none;">ACAMI</a></li>
  </ul>
</div>
...
<div class="note-box">
<p><strong>Nota aclaratoria:</strong> las fuentes contemporáneas y la bibliografía no se ponen de acuerdo sobre la fecha exacta del primer despegue controlado del C.4 en Getafe, que unas dan el 9 de enero y otras el 17 de enero de 1923. El Ejército del Aire, el Centenario del Autogiro y la Real Academia de la Historia se inclinan por el 17 de enero, y ese día se celebró en 2023 el centenario. El hecho del 31 de enero, en cambio, está documentado con fecha exacta gracias al certificado oficial firmado por Emilio Herrera Linares al día siguiente, por lo que no ofrece dudas. Sobre la planta motriz, las fuentes citan indistintamente un Le Rhône 9C de 80 CV o un Le Rhône 9Ja de 110 CV; el artículo de Félix García Merayo en <em>Acta</em>, que reproduce la documentación técnica original, se inclina por el 9Ja de 110 CV, que es la cifra que aquí se adopta. El presente post no se refiere al primer despegue o salto del C.4, sino al <strong>primer vuelo en circuito cerrado y sostenido</strong> del aparato, que es el hito reconocido por la FAI.</p>
</div>
