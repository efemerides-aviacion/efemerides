---
layout: post
title: "25 de julio de 1909 | Louis Blériot y la hazaña que unió el cielo con la historia"
date: 1909-07-25
categories: [evento]
author: Enrique Pomares
pais: Francia
operator: N/A
excerpt: "El aviador e ingeniero francés Louis Blériot completa la primera travesía aérea del Canal de la Mancha a bordo de su monoplano Blériot XI, uniendo Les Baraques con Dover en 36 minutos."
image: 1909-07-25-louis-bleriot-cruce-canal-mancha.webp
---

<figure>
  <img class="post-image" src="{{ site.baseurl }}/assets/img/1909-07-25-louis-bleriot-cruce-canal-mancha.webp" alt="Louis Blériot y su monoplano Type XI en Northfall Meadow cerca del Castillo de Dover poco después de aterrizar desde Francia">
...
<p>El 25 de julio de 1909, el aviador e ingeniero francés Louis Charles Joseph Blériot protagonizó una de las hazañas más célebres en la historia de la aviación al convertirse en el primer ser humano en cruzar el Canal de la Mancha a bordo de una aeronave más pesada que el aire. Despegando a las 04:41 a. m. desde el campo de Les Baraques, cerca de Sangatte (Calais, Francia), Blériot voló durante 36 minutos y 30 segundos sobre las aguas del estrecho hasta aterrizar en Northfall Meadow, en las inmediaciones del Castillo de Dover (Kent, Reino Unido), cubriendo una distancia aproximada de 36,6 km (22,5 millas marítimas).</p>
...
- **Ruta:** Les Baraques (cerca de Sangatte, Calais, Francia) – Northfall Meadow (junto al Castillo de Dover, Kent, Reino Unido).
- **Distancia recorrida:** Aproximadamente 36,6 km (22,5 millas marítimas).
- **Duración total del vuelo:** 36 minutos y 30 segundos.
- **Protagonista:** Louis Charles Joseph Blériot (ingeniero e inventor francés, 1872–1936).
- **Aeronave:** Monoplano tractor Blériot XI (fuselaje en celosía de fresno reforzado con tensores de cable de acero).
...
### Entorno social
A comienzos del siglo XX, la prensa británica y europea utilizaba los retos aeronáuticos para impulsar las tiradas de periódicos y movilizar el entusiasmo popular. La recompensa establecida por Lord Northcliffe, propietario del *Daily Mail*, desató una verdadera carrera tecnológica entre los talleres aeronáuticos de Francia y el Reino Unido. En la sociedad británica, el intento de sobrevolar el canal dividió la opinión pública entre la fascinación por el progreso científico y la creciente inquietud de los sectores militares por la pérdida de la barrera defensiva natural del Atlántico y el Mar del Norte.

### Entorno tecnológico
Hacia 1909, la aviación mundial estaba dominada por los biplanos pesados impulsados por motores de automóvil adaptados. Blériot desafió la corriente dominante al apostar por una configuración monoplana tractora de ala alta, ligera y aerodinámicamente eficiente. El elemento crítico de la nave fue la adopción del motor italiano Anzani de 25 hp y la hélice *Chauvière Intégrale*, cuyas palas de madera laminada ofrecían una eficiencia superior al 80 %, permitiendo mantener la sustentación continua con un consumo reducido de combustible.
...
- **10 de octubre de 1908:** El periódico británico *Daily Mail* anuncia el desafío y ofrece £500 (suma duplicada a £1.000 en mayo de 1909) para el primer aviador que cruce volando el Canal de la Mancha.
- **23 de enero de 1909:** Vuelo inaugural del prototipo monoplano Blériot XI en el campo de aviación de Issy-les-Moulineaux.
- **19 de julio de 1909:** El piloto anglo-francés Hubert Latham realiza el primer intento a bordo del monoplano Antoinette IV, cayendo al mar por falla del motor a 11 km de Dover.
- **25 de julio de 1909 (02:30 BST):** Blériot despierta en su hotel de Calais, evalúa la calma del viento y ordena preparar el Blériot XI para el vuelo..
- **25 de julio de 1909 (04:41 BST):** Despegue desde el prado de Les Baraques a una velocidad de unos 60 km/h. Blériot sigue visualmente al destructor de la Marina Francesa *Escopette*, enviado para escoltarlo.
- **25 de julio de 1909 (04:55 BST):** Sobre el centro del canal, el viento desplaza a la nave y la niebla marina oculta la costa y el barco escolta. Blériot vuela sin brújula ni altímetro durante 10 minutos, orientado únicamente por el rugido constante del motor Anzani.
