...
excerpt: "El 26 de abril de 1939, el piloto de pruebas alemán Fritz Wendel estableció un nuevo récord mundial de velocidad en aviones con motor a pistón al alcanzar 755,14 km/h a bordo del Messerschmitt Me 209 V1, una marca que se mantuvo vigente durante 30 años."
image: 1939-04-26-record-mundial-velocidad-avion-motor-piston.webp
---

<figure>
  <img class="post-image" src="{{ site.baseurl }}/assets/img/1939-04-26-record-mundial-velocidad-avion-motor-piston.webp" alt="Willy Messerschmitt y Fritz Wendel junto al Me 209 V1">
...
- **Fecha del récord:** 26 de abril de 1939
- **Lugar:** Aeródromo de Augsburgo, Alemania
- **Piloto:** Fritz Wendel (piloto jefe de pruebas de Messerschmitt)
- **Aeronave:** Messerschmitt Me 209 V1, matrícula civil D‑INJR
- **Motor:** Daimler-Benz DB 601 ARJ (configuración especial para récord)
- **Potencia máxima estimada:** 2.300 hp (en breves periodos)
- **Distancia del circuito:** 3 kilómetros (recorrido de ida y vuelta)
- **Velocidad media:** 755,14 km/h (469,22 mph)
...
El motor de pistón había alcanzado su madurez tecnológica a finales de la década de 1930. Los ingenieros alemanes habían desarrollado sistemas de inyección directa de combustible (Daimler-Benz DB 601) que permitían alcanzar potencias sin precedentes. Para los aviones de récord, se utilizaban configuraciones especiales de motor (como el DB 601 ARJ del Me 209) que permitían sobrealimentación extrema durante cortos periodos, a costa de una vida útil muy reducida del motor (apenas unas horas). El problema de la refrigeración era crítico para alcanzar altas velocidades, y se empleaban sistemas evaporativos que utilizaban el agua de refrigeración atomizada para disipar el calor.
...
- **Alas:** Muy pequeñas (envergadura de solo 7,8 metros) para reducir la resistencia aerodinámica.
- **Fuselaje:** Extremadamente estilizado, con una sección transversal mínima.
- **Cabina:** El piloto iba casi tumbado, con el asiento reclinado para reducir la sección frontal.
- **Refrigeración:** Utilizaba un sistema evaporativo que atomizaba el agua de refrigeración, que luego se condensaba mediante tomas de aire en las alas.

### El motor DB 601 ARJ

El Daimler-Benz DB 601 ARJ era una versión especial del motor DB 601 que equipaba a los Bf 109 estándar. Se modificó para poder funcionar con sobrealimentación extrema durante cortos periodos (apenas 30 segundos a máxima potencia), alcanzando una potencia estimada de 2.300 hp. El motor estaba diseñado para durar apenas unas horas de vuelo, una vida útil inaceptable para un avión militar pero suficiente para un intento de récord.
...
- **Prestigio para Messerschmitt:** El récord consolidó la reputación de Willy Messerschmitt como diseñador de aviones de alto rendimiento, lo que le valió contratos de producción para la Luftwaffe.
...
El récord de Fritz Wendel con el Messerschmitt Me 209 V1 representa el punto culminante de la era de los aviones de pistón de hélice. Apenas dos años después, en 1941, los primeros cazas a reacción (como el Messerschmitt Me 262) comenzarían a volar, inaugurando una nueva era tecnológica.
