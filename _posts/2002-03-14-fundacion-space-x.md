...
- **Protagonistas:** Elon Musk (fundador), Tom Mueller (primer empleado clave, ingeniero de propulsión), Gwynne Shotwell (incorporada posteriormente como presidenta y COO)
- **Empresa fundada:** Space Exploration Technologies Corp. (SpaceX)
...
### Entorno social
Tras los atentados del 11 de septiembre de 2001, Estados Unidos vivía un clima de incertidumbre pero también de replanteamiento tecnológico y militar. La exploración espacial había perdido el impulso de la era Apolo, y la NASA enfrentaba recortes presupuestarios. Sin embargo, la burbuja puntocom había generado una nueva generación de emprendedores tecnológicos con grandes fortunas y visiones de futuro, como Jeff Bezos (Blue Origin) y Elon Musk.

### Entorno tecnológico
La tecnología de cohetes se basaba en diseños de los años 60 y 70, con sistemas desechables que se perdían en cada lanzamiento. El transbordador espacial, aunque parcialmente reutilizable, resultaba extremadamente costoso y complejo. Los motores de combustión líquida habían alcanzado madurez, pero su fabricación seguía siendo artesanal y cara. La computación y los sistemas de control avanzaban rápidamente, ofreciendo nuevas posibilidades para la navegación autónoma.
...
- **Febrero de 2002:** En el vuelo de regreso a Estados Unidos tras una frustrante negociación en Moscú, Musk decide que puede fundar su propia empresa para construir cohetes más asequibles, aplicando integración vertical y componentes comerciales .
- **Principios de 2002:** Musk comienza a reclutar a los primeros empleados. Contacta a Tom Mueller (experto en propulsión de TRW), Chris Thompson, y brevemente a Jim Cantrell y Michael Griffin (quien luego sería administrador de la NASA) . Mueller se convierte en el primer empleado clave y desarrollará los motores Merlin.
- **14 de marzo de 2002:** Se constituye legalmente Space Exploration Technologies Corp. en el estado de Delaware, fecha oficial de fundación .
...
- **Democratización del espacio:** Demostró que una empresa privada podía desarrollar cohetes orbitales por una fracción del costo tradicional, rompiendo el monopolio de los grandes contratistas y agencias gubernamentales.
- **Innovación forzada:** Obligó a los competidores establecidos (Arianespace, ULA, etc.) a replantear sus modelos de negocio y a buscar eficiencias para competir con los precios de SpaceX.
- **Desarrollo de cohetes reutilizables:** La visión inicial de abaratar costos llevó directamente al programa de reutilización del Falcon 9, que cambió para siempre la economía de los lanzamientos espaciales.
- **Creación del ecosistema comercial:** SpaceX allanó el camino para una nueva generación de empresas espaciales (Rocket Lab, Relativity Space, etc.) y demostró que el modelo de negocio era viable.

### Grandes hitos posteriores (evolución cronológica)

- **2006:** Primer vuelo del Falcon 1 (fracaso). NASA adjudica a SpaceX el contrato COTS para desarrollar capacidad de abastecimiento a la ISS .
- **28 de septiembre de 2008:** El Falcon 1 se convierte en el primer cohete de combustible líquido desarrollado con financiación privada en alcanzar la órbita terrestre .
- **Diciembre de 2008:** NASA otorga a SpaceX el contrato CRS por 1.600 millones de dólares para 12 misiones de reabastecimiento a la ISS, salvando a la empresa de la bancarrota .
- **Junio de 2010:** Primer vuelo del Falcon 9 .
- **Diciembre de 2010:** Dragon se convierte en la primera nave comercial en ser puesta en órbita y recuperada con éxito .
- **25 de mayo de 2012:** Dragon es la primera nave comercial en acoplarse a la ISS .
- **Diciembre de 2015:** Primera recuperación exitosa de la primera etapa de un Falcon 9 en tierra firme .
- **Abril de 2016:** Primera recuperación exitosa en una plataforma marítima (droneship) .
- **Marzo de 2017:** Primer relanzamiento de una primera etapa recuperada .
- **Febrero de 2018:** Vuelo inaugural del Falcon Heavy, que pone un Tesla Roadster en órbita solar .
...
- **Pionera en cohetes reutilizables:** Demostró que los cohetes orbitales pueden aterrizar y volver a volar, reduciendo drásticamente los costos de lanzamiento.
- **Dominio del mercado:** En 2024, SpaceX se ha convertido en el proveedor de lanzamientos dominante a nivel mundial, con una cadencia que eclipsa a todos los demás competidores, incluyendo programas nacionales como el chino .
- **Motor de la nueva economía espacial:** Ha viabilizado el despliegue de megaconstelaciones (Starlink) y ha reducido las barreras de entrada para misiones científicas y comerciales.
