...
excerpt: "El 26 de mayo de 2010, el Boeing X-51A WaveRider completó el vuelo propulsado por scramjet más largo de la historia, alcanzando Mach 5 durante 140 segundos. Lanzado desde un B-52H frente a la costa de California, el demostrador no tripulado estableció un nuevo récord que sentó las bases para el desarrollo de armas hipersónicas y acceso al espacio."
image: 2010-05-26-primer-vuelo-boeing-x-51-waverider.webp
...
- **Motor scramjet:** Pratt & Whitney Rocketdyne SJY61 (combustible JP-7) 
- **Cohete acelerador:** MGM-140 ATACMS (solid rocket booster) 
- **Velocidad máxima alcanzada:** Mach 5 (aproximadamente 3.300 mph o 5.300 km/h) 
- **Altitud máxima:** 70.000 pies (21.000 metros) 
- **Duración del vuelo propulsado por scramjet:** 140 segundos (récord mundial en ese momento) 
- **Duración total del vuelo autónomo:** más de 200 segundos 
- **Récord anterior (X-43):** 12 segundos de combustión scramjet 
- **Número de vehículos construidos:** 4 
- **Organizaciones participantes:** USAF Air Force Research Laboratory (AFRL), DARPA, NASA, Boeing, Pratt & Whitney Rocketdyne, Armada de EE. UU. 

<hr style="margin: 2rem 0; border: none; height: 2px; background: linear-gradient(to right, #1565c0, #42a5f5);">

## Contexto Histórico

El vuelo del X-51A WaveRider representó un hito en la búsqueda de vuelos hipersónicos sostenidos, una frontera tecnológica que había eludido a los investigadores durante décadas.

### Entorno social

A finales de la primera década del siglo XXI, Estados Unidos buscaba mantener su superioridad tecnológica frente a potencias emergentes como China y Rusia, que también desarrollaban tecnologías hipersónicas. El X-51A fue concebido como un demostrador para probar la viabilidad de motores scramjet alimentados por hidrocarburos, una tecnología prometedora para aplicaciones militares y de acceso al espacio. El vuelo del 26 de mayo de 2010 recibió amplia cobertura mediática y fue celebrado como un avance significativo. Charlie Brink, gerente del programa X-51A en el Laboratorio de Investigación de la Fuerza Aérea, declaró: *"Equiparamos este salto en la tecnología de motores como equivalente al salto de la aviación de hélice a la de reacción después de la Segunda Guerra Mundial"*.
...
El X-51A fue apodado "WaveRider" en honor a los diseños aerodinámicos teóricos de los años 1950 que aprovechaban las ondas de choque para mejorar la sustentación. El programa fue gestionado por el Laboratorio de Investigación de la Fuerza Aérea (AFRL) en la Base Wright-Patterson, Ohio, con la participación de la DARPA, NASA, Boeing y Pratt & Whitney Rocketdyne. La colaboración público-privada fue clave para el éxito del programa.
...
- **9 de diciembre de 2009:** Primer vuelo cautivo del X-51A acoplado a un B-52H.
- **25 de mayo de 2010 (previsto):** Primer vuelo de prueba programado, pero pospuesto por la presencia de un barco de carga en el área de pruebas del mar.
- **26 de mayo de 2010, aproximadamente 10:00 PDT:** Despegue del B-52H desde Edwards AFB con el X-51A bajo su ala izquierda.
- **Aproximadamente 50.000 pies (15.240 m):** El X-51A es liberado del B-52H.
- **+4 segundos:** Se enciende el cohete acelerador sólido MGM-140 ATACMS.
- **Aceleración a Mach 4,8:** El cohete impulsa el X-51A hasta aproximadamente Mach 4,8.
- **Separación del cohete y encendido del scramjet:** El cohete y la sección de interstage se separan. El motor scramjet SJY61 se enciende con una mezcla de etileno y JP-7 antes de cambiar exclusivamente a JP-7.
- **Vuelo scramjet de 140 segundos:** El vehículo acelera a Mach 5 y alcanza 70.000 pies de altitud.
...
- **Transporte comercial hipersónico:** Viajes intercontinentales en cuestión de horas.
- **Acceso al espacio:** Sistemas de lanzamiento reutilizables de dos etapas con scramjet.
...
<div class="note-box">
  ...
  <p><strong>1. Duración del vuelo propulsado por scramjet:</strong> Las fuentes presentan variaciones en la cifra exacta: Boeing y FlightGlobal indican <strong>140 segundos</strong> de combustión del scramjet ; la Fuerza Aérea de EE. UU. y DVIDS indican que el vuelo autónomo total duró "más de 200 segundos", con "entre 140 y 170 segundos de datos limpios del motor". La cifra de 140 segundos es la más citada en fuentes especializadas y se refiere específicamente al tiempo en que el scramjet estuvo produciendo empuje.</p>
  <p><strong>2. Velocidad exacta:</strong> Las fuentes coinciden en <strong>Mach 5</strong> como la velocidad máxima alcanzada. Algunas fuentes citan "aproximadamente Mach 5" (China Daily) , mientras que Wikipedia indica Mach 5 exacto. No hay discrepancia significativa.</p>
  <p><strong>3. Récord anterior del X-43:</strong> El X-43 de la NASA alcanzó Mach 9,68 en 2004, pero su motor scramjet quemó durante solo <strong>12 segundos</strong>. El récord del X-51A fue de <strong>duración de vuelo propulsado por scramjet</strong>, no de velocidad máxima.</p>
  <p><strong>4. Estado del programa:</strong> El X-51 completó su último vuelo el 1 de mayo de 2013. El vehículo alcanzó Mach 5,1 durante 210 segundos antes de quedarse sin combustible. El programa se considera completado y los cuatro vehículos construidos han sido utilizados.</p>
</div>
