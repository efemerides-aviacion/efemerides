...
pais: Estados Unidos
operator: NASA
excerpt: "El transbordador espacial Columbia se desintegra sobre Texas durante la reentrada atmosférica al término de la misión STS-107, provocando la pérdida de sus siete tripulantes e impulsando reformas profundas en la NASA."
...
- **Misión:** STS-107 (113.ª misión del programa Space Shuttle y 28.º vuelo del Columbia).
- **Aeronave / Orbiter:** Transbordador espacial Columbia (Orbiter Vehicle OV-102).
- **Operador:** Administración Nacional de Aeronáutica y del Espacio (NASA).
- **Tripulación fallecida (7 integrantes):**
  - **Rick D. Husband** (Comandante, Coronel de la USAF).
  - **William C. McCool** (Piloto, Comandante de la US Navy).
  - **Michael P. Anderson** (Comandante de Carga, Teniente Coronel de la USAF).
  - **David M. Brown** (Especialista de Misión, Capitán de la US Navy).
  - **Kalpana Chawla** (Especialista de Misión, ingeniera aeroespacial).
  - **Laurel Clark** (Especialista de Misión, Comandante de la US Navy y cirujana de vuelo).
  - **Ilan Ramon** (Especialista de Carga, Coronel de la Fuerza Aérea Israelí).
- **Duración de la misión hasta la desintegración:** 15 días, 22 horas, 20 minutos y 32 segundos.
...
### Entorno social
La desintegración televisada del Columbia conmocionó a la opinión pública internacional, evocando la memoria del dolor provocado 17 años antes por la tragedia del Challenger. En los Estados Unidos e Israel —país que conmemoraba la participación de su primer astronauta, el Coronel Ilan Ramon— la tragedia desató jornadas de duelo nacional. La pérdida de una tripulación diversa, integrada por científicos y militares de alto nivel, derivó en una exhaustiva fiscalización del Congreso estadounidense sobre el presupuesto, la supervisión de seguridad y las prioridades estratégicas de la NASA.

### Entorno tecnológico
A comienzos del siglo XXI, el programa del transbordador espacial enfrentaba la presión de mantener un ritmo constante de lanzamientos para dar servicio a la construcción de la Estación Espacial Internacional. El tanque externo de combustible, recubierto de espuma aislante térmica para evitar la formación de hielo en sus propelentes criogénicos, había registrado desprendimientos de material en múltiples misiones previas. Aunque los ingenieros consideraban el desprendimiento de espuma un problema recurrente, las instancias directivas de la NASA tendieron a categorizarlo como un riesgo aceptable de mantenimiento en lugar de una amenaza crítica para la supervivencia de la nave.
...
- **12 de abril de 1981:** Se efectúa el <a href="https://efemerides-aviacion.github.io/efemerides/espacial/1981/04/12/primer-vuelo-transbordador-columbia.html" style="color: #315fea; text-decoration: none;">primer vuelo del Transbordador Espacial Columbia</a> (STS-1), inaugurando la era operacional de la flota reutilizable de la NASA.
- **28 de enero de 1986:** Se produce el <a href="https://efemerides-aviacion.github.io/efemerides/espacial/accidente/1986/01/28/accidente-challenger-sts51l.html" style="color: #315fea; text-decoration: none;">accidente del Challenger STS-51-L</a> durante el despegue, representando el primer antecedente mortal del programa.
- **16 de enero de 2003 (10:39 EST / 15:39 UTC):** Lanzamiento limpio de la misión STS-107 desde la Rampa 39A del Centro Espacial Kennedy.
- **16 de enero de 2003 (T+81,7 segundos):** Un bloque de espuma aislante se desprende de la rampa del tanque externo a Mach 2,46 e impacta a 870 km/h contra el panel número 8 del ala izquierda del Columbia.
- **17 a 31 de enero de 2003:** La tripulación ejecuta con éxito más de 80 experimentos científicos a bordo del módulo presurizado SPACEHAB. Las peticiones técnicas internas para analizar el impacto del ala son rechazadas por la gerencia de vuelo.
- **1 de febrero de 2003 (08:15:30 EST):** Encendido de desórbita exitoso de los motores OMS sobre el Océano Índico.
- **1 de febrero de 2003 (08:44:09 EST):** Entrada en la atmósfera superior a Mach 25; el plasma térmico comienza a ingresar al interior de la estructura del ala izquierda dañada.
- **1 de febrero de 2003 (08:53:46 EST):** Primeras lecturas anómalas en el sensor de presión de los neumáticos del tren de aterrizaje izquierdo mientras la nave vuela sobre California.
...
- **Timestamp de verificación:** 2026-07-17 08:29:35 America/Mexico_City
...
- **Fuentes secundarias de contraste:** RTVE Noticias, Encyclopædia Britannica, borrador preliminar del investigador.
