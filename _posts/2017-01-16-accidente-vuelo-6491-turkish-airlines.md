...
excerpt: "El 16 de enero de 2017, un Boeing 747-412F (TC-MCL) de ACT Airlines, operando como vuelo 6491 de Turkish Airlines Cargo, se estrelló durante la aproximación al aeropuerto de Manas en Bishkek, Kirguistán. Las cuatro personas a bordo fallecieron, junto con 35 residentes en tierra, totalizando 39 víctimas. La investigación determinó que la tripulación capturó una falsa senda de planeo del ILS (9° en lugar de 3°), ignoró las alertas del GPWS e inició un go-around demasiado tarde, a solo 58 pies de altura."
image: 2017-01-16-accidente-vuelo-6491-turkish-airlines.webp
---
...
- **Ruta prevista:** Aeropuerto Internacional de Hong Kong (HKG) – Aeropuerto de Manas, Bishkek (FRU) – Aeropuerto de Estambul Atatürk (ISL)
- **Carga:** 85,618 kg (incluyendo 73,186 kg de equipaje, 12,432 kg de piezas de automóviles, textiles y productos electrónicos)
- **Designador de vuelo:** TK6491 (IATA) / THY6491 (ICAO)
- **Aeronave:** Boeing 747-412F (carguero)
- **Número de serie (MSN):** 35274
- **Número de línea (Line Number):** 1395
- **Matrícula:** TC-MCL
- **Año de fabricación:** 2003 (primer vuelo: 12 de febrero de 2003)
- **Motores:** 4 × Pratt & Whitney PW4062
- **Horas de vuelo acumuladas:** 66,089 horas (en el momento del accidente)
- **Ciclos de vuelo:** 9,660 ciclos
- **Propietario:** ACT Airlines (MyCargo Airlines), operando bajo wet lease para Turkish Airlines Cargo
- **Personas a bordo:** 4 (tres pilotos, un técnico de carga)
- **Víctimas mortales:** 39 (4 a bordo + 35 en tierra)
- **Heridos en tierra:** Aproximadamente 15-20
- **Viviendas destruidas:** 43
...
El accidente del vuelo TK6491 ocurrió en el contexto de las operaciones de carga aérea internacional, un sector con menor visibilidad mediática que la aviación comercial de pasajeros, pero con riesgos operativos específicos, incluyendo horarios nocturnos, fatiga de tripulaciones y presión por cumplir tiempos de tránsito.

### Entorno social

Kirguistán, un país de aproximadamente 6 millones de habitantes en Asia Central, no estaba acostumbrado a desastres aéreos de esta magnitud. La aldea de Dacha-Suu, ubicada en la ruta de aproximación al aeropuerto de Manas, albergaba a familias de bajos recursos. El impacto destruyó 43 viviendas y causó una conmoción nacional. El gobierno kirguiso declaró luto nacional el 17 de enero de 2017.

### Entorno tecnológico

El Boeing 747-412F era un carguero de última generación equipado con sistemas avanzados de navegación, incluyendo ILS (Instrument Landing System) y GPWS (Ground Proximity Warning System). Sin embargo, el accidente demostró que estos sistemas no son infalibles: el ILS del aeropuerto de Manas, debido a la topografía local, podía generar falsas sendas de planeo en frecuencias armónicas (9°, 15°, etc.), un fenómeno conocido por los pilotos locales pero no por tripulaciones extranjeras. El GPWS emitió alertas de "SINK RATE", "PULL UP" y "TOO LOW TERRAIN", pero fueron ignoradas.
...
- **Recomendaciones de la CIAA:**
    ...
    - A la CIAA y a la OACI: Revisar las cartas de aproximación ILS para aeropuertos con topografía compleja, incluyendo advertencias explícitas sobre falsas sendas de planeo.
...
El accidente del vuelo TK6491 es el peor desastre aéreo en la historia de Kirguistán y uno de los accidentes de carga más mortíferos del siglo XXI.

- **Cambios en cartas de aproximación:** La OACI emitió directrices para que todos los aeropuertos con riesgo de falsas sendas de planeo incluyan advertencias explícitas en sus cartas de aproximación ILS.

- **Entrenamiento en respuesta a GPWS:** Las aerolíneas de carga y pasajeros reforzaron los simuladores de vuelo para entrenar a las tripulaciones en respuestas inmediatas a alertas de "PULL UP", sin intentar diagnosticar la causa antes de ejecutar el procedimiento.

- **Gestión de la fatiga:** El accidente impulsó la implementación de sistemas FRMS (Fatigue Risk Management Systems) más rigurosos en el sector de carga aérea, donde los horarios nocturnos y las largas jornadas son comunes.

- **Compensaciones:** Turkish Airlines y ACT Airlines establecieron un fondo de compensación para las familias de las víctimas en tierra, pagando aproximadamente 1.5 millones de dólares en total.

- **Memorial:** En la aldea de Dacha-Suu se erigió un monumento en memoria de las 39 víctimas. Cada 16 de enero, residentes y familiares realizan una ceremonia de recordación.
...
<div class="note-box">
  ...
  <ul>
    <li>El vuelo era operado por ACT Airlines bajo la marca "MyCargo Airlines", pero utilizaba el código de vuelo de Turkish Airlines (TK) bajo un contrato de wet lease.</li>
    <li>La cifra de víctimas varía ligeramente entre fuentes (entre 37 y 39). El informe oficial de la CIAA confirma 39: 4 a bordo y 35 en tierra.</li>
    <li>El aeropuerto de Manas también es conocido como Aeropuerto Internacional de Bishkek (código FRU).</li>
    <li>La falsa senda de planeo del ILS a 9° fue generada por la reflexión de la señal en las montañas cercanas al aeropuerto, un fenómeno conocido localmente pero no adecuadamente documentado en las cartas de navegación internacionales.</li>
  </ul>
</div>
...
- **Discrepancias resueltas:**
  ...
  - Altura del go-around: 58 pies sobre el nivel del suelo, confirmado por el FDR.
  - Duración de las alertas del GPWS: 17 segundos antes del impacto.
