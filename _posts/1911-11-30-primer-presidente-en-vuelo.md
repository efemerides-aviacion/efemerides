...
<figure>
  <img class="post-image" src="{{ site.baseurl }}/assets/img/1911-11-30-primer-presidente-en-vuelo.webp" alt="Francisco I. Madero en el avión">
...
### Entorno social
México se encontraba en un periodo de transición política profunda tras la caída de Porfirio Díaz. El gesto de Madero fue visto como un acto de valentía y cercanía con la tecnología moderna.
### Entorno tecnológico
La aviación era una disciplina incipiente; los monoplanos tipo Blériot representaban la vanguardia de la ingeniería aeronáutica de la época, aunque todavía se consideraban máquinas de alto riesgo.
### Entorno cultural
...
<div class="references">
  <ul>
    ...
    <li><a href="https://fundacioncarlosslim.org/franciso-i-madero-los-aires/" style="color: #315fea; text-decoration: none;">México Desconocido / Fundación Carlos Slim – «El primer vuelo en avión de Francisco I. Madero»</a></li>
      <li><a href="https://es.wikipedia.org/wiki/Francisco_I._Madero" style="color: #315fea; text-decoration: none;">Wikipedia (ES) — Francisco I. Madero</a></li>
  </ul>
</div>
<hr style="margin: 2rem 0; border: none; height: 2px; background: linear-gradient(to right, #1565c0, #42a5f5);">
