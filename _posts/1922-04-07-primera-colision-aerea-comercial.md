...
excerpt: "El 7 de abril de 1922, un de Havilland DH.18A británico y un Farman F.60 Goliath francés colisionaron en pleno vuelo sobre Picardía, Francia, en condiciones de niebla. Fue la primera colisión aérea entre dos aviones de línea comerciales de la historia, cobrándose la vida de las siete personas a bordo."
image: 1922-04-07-primera-colision-aerea-comercial.webp
---

<figure>
  <img class="post-image" src="{{ site.baseurl }}/assets/img/1922-04-07-primera-colision-aerea-comercial.webp" alt="Farman F.60 Goliath y de Havilland DH.18A, aviones involucrados en la primera colisión aérea comercial">
...
- **Hora del accidente:** 14:00 (hora local)
- **Lugar:** Thieuloy-Saint-Antoine, Picardía, Francia (departamento de Oise, región de Hauts-de-France)
- **Coordenadas:** 49°38′00″N 01°56′49″E
- **Primera aeronave:** Farman F.60 Goliath
...
- **Pasajeros (primera):** 3
- **Víctimas (primera):** 5
- **Segunda aeronave:** de Havilland DH.18A
...
- **Altitud de vuelo:** 150 metros (492 pies)
...
### Entorno tecnológico
Ambas aeronaves eran biplanos de madera y tela. El Farman F.60 Goliath era un bombardero convertido, con capacidad para 12 pasajeros en configuración civil. El de Havilland DH.18A era un avión de correo y pasajeros, con cabina cerrada para cuatro pasajeros. En aquella época, los sistemas de navegación eran primitivos: los pilotos volaban visualmente (VFR), utilizando puntos de referencia terrestres como ríos, carreteras y líneas de ferrocarril.
...
- **Reglas de vuelo universales:** Tras el accidente, se celebró una reunión en el aeropuerto de Croydon con representantes de las principales aerolíneas europeas (CGEA, Daimler Airway, Handley Page Transport, Instone Air Line, KLM) y del Ministerio del Aire británico. Entre las resoluciones adoptadas, se estableció que la regla universal de vuelo sería **"mantenerse a la derecha"** (similar a la circulación por carretera), para evitar colisiones frontales.
- **Visibilidad del piloto:** Se acordó que los nuevos aviones de línea debían ofrecer una visión clara hacia delante para el piloto, sin obstrucciones.
