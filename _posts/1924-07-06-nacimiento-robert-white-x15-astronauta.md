...
excerpt: "El 6 de julio de 1924 nació Robert Michael White, piloto de pruebas de la Fuerza Aérea de EE. UU. que llevó al X-15 a récords de velocidad y altitud y recibió las primeras alas de astronauta otorgadas a un piloto de avión."
image: 1924-07-06-nacimiento-robert-white-x15-astronauta.webp
---
...
- **Fallecimiento:** 17 de marzo de 2010, Orlando, Florida, Estados Unidos
- **Servicio militar:** United States Army Air Forces y United States Air Force
- **Rango final:** Mayor General, USAF
- **Formación académica:** ingeniería eléctrica (New York University, 1951); administración de empresas (George Washington University, 1966)
- **Aeronaves destacadas:** North American P-51 Mustang, Lockheed F-80 Shooting Star, Republic F-105 Thunderchief, North American X-15
- **Hito principal en el X-15:** 314.750 pies de altitud el 17 de julio de 1962
- **Récords destacados:** primer piloto en superar Mach 4, Mach 5 y Mach 6 en un avión tripulado
...
### Entorno social
La generación de White creció entre la Gran Depresión y la movilización masiva de la Segunda Guerra Mundial. Para muchos jóvenes estadounidenses, la aviación militar se convirtió en una vía de formación técnica, ascenso social y servicio nacional. White encarnó esa transición: de cadete en tiempo de guerra a oficial altamente especializado en la posguerra.

### Entorno tecnológico
En apenas dos décadas, la aviación pasó de los cazas de hélice a los reactores y de estos a los programas hipersónicos. El X-15 fue una plataforma crucial en esa evolución, al investigar materiales, control de vuelo, fisiología humana y perfiles de reentrada a velocidades extremas. White formó parte del reducido grupo de pilotos que expandieron esos límites con datos útiles para Mercury, Gemini, Apollo y, más tarde, el transbordador espacial.
...
- **6 de julio de 1924:** nace Robert Michael White en Manhattan, Nueva York.
...
- **15 de abril de 1960:** realiza su primer vuelo en el X-15 como piloto de la Fuerza Aérea.
...
- **Validación del vuelo hipersónico tripulado:** sus récords de Mach 4, 5 y 6 demostraron que un piloto podía controlar un aparato en regímenes antes apenas explorados.
- **Avance en perfiles de gran altitud:** el vuelo del 17 de julio de 1962 amplió los datos sobre control, estabilidad y exigencias fisiológicas en el borde del espacio.
- **Contribución a programas posteriores:** la información reunida en el X-15 ayudó a madurar conocimientos aplicables a proyectos espaciales y a aeronaves de altas prestaciones.
