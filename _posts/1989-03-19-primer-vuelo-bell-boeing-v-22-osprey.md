---
layout: post
title: "19 de marzo de 1989 | Primer vuelo del Bell-Boeing V-22 Osprey"
date: 1989-03-19
categories: [evento]
...
- **Lugar:** Arlington, Texas, Estados Unidos
- **Protagonistas:** Bell Helicopter, Boeing, tripulación de pruebas del prototipo #01
...
A mediados de la década de 1980, el Departamento de Defensa de los Estados Unidos lanzó el programa JVX (Joint-service Vertical take-off/landing Experimental) para desarrollar una aeronave que combinara las capacidades de despegue y aterrizaje vertical de un helicóptero con la velocidad y eficiencia de un avión turbohélice. El objetivo era reemplazar flotas envejecidas de helicópteros de transporte medio y de asalto con un diseño revolucionario.

### Entorno social
La Guerra Fría se encontraba en su etapa final, con Estados Unidos manteniendo una fuerte presencia militar global. Las operaciones de proyección de poder requerían aeronaves versátiles capaces de operar desde buques y bases avanzadas. El V-22 se concebía como un multiplicador de fuerzas para el Cuerpo de Marines y otras ramas, ofreciendo mayor velocidad y alcance que los helicópteros convencionales.

### Entorno tecnológico
La tecnología de rotores basculantes (tiltrotor) había sido explorada experimentalmente desde los años 50 con aeronaves como el XV-3 y el XV-15, este último desarrollado por Bell Helicopter. El XV-15 demostró la viabilidad del concepto y sirvió como banco de pruebas para el programa V-22. La electrónica de control fly-by-wire y los materiales compuestos estaban madurando, permitiendo un diseño más eficiente y ligero.
...
- **1983:** Bell y Boeing forman un consorcio para desarrollar el V-22, combinando la experiencia de Bell en rotores basculantes con la capacidad industrial de Boeing.
- **1985:** Se firma el contrato de desarrollo a gran escala.
- **1988:** Se completa el primer prototipo del V-22 (designado #01). Comienzan las pruebas en tierra y los vuelos cautivos.
- **19 de marzo de 1989:** El prototipo #01 realiza su primer vuelo libre en Arlington, Texas, operando en modo helicóptero durante aproximadamente 15 minutos. La tripulación verifica los mandos de vuelo, la estabilidad y el control en sustentación vertical.
- **Agosto de 1989:** El prototipo completa su primera conversión a vuelo de ala fija, demostrando la transición entre modos.
- **1990-1999:** El programa sufre múltiples contratiempos: accidentes fatales (en 1991 y 1992), problemas de fatiga en la estructura, sobrecostes y revisiones de diseño. La producción a baja tasa se inicia en 1997.
- **2000-2005:** Se rediseñan componentes, se mejoran los sistemas y se reanudan las pruebas con un enfoque más riguroso.
- **2007:** El V-22 entra oficialmente en servicio con el Cuerpo de Marines de los Estados Unidos, casi 18 años después de su primer vuelo.
...
- **Fuentes primarias/institucionales consultadas:** FlightGlobal, European Airshows, Boeing Defense (X), Vertical Flight Society (YouTube), AFOTEC, ERF Technical Report  
