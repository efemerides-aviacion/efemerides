---
layout: post
title: "2 de julio de 1937 | La misteriosa desaparición de Amelia Earhart en el Pacífico"
date: 1937-07-02
categories: [evento]
author: Enrique Pomares
pais: Estados Unidos
operator: Aero Club de America
excerpt: "El 2 de julio de 1937, la legendaria aviadora Amelia Earhart y su navegante Fred Noonan desaparecieron sobre el océano Pacífico central a bordo de su bimotor Lockheed L-10E Electra durante su intento de circunnavegar el globo."
image: 1937-07-02-desaparicion-amelia-earhart.webp
...
- **Planta motriz del bimotor:** Dos motores radiales sobrealimentados de nueve cilindros refrigerados por aire Pratt & Whitney R-1340 Wasp S3H1, que producían 550 CV de potencia cada uno
- **Fecha de declaración legal de fallecimiento:** 5 de enero de 1939 (decretado tras año y medio de la desaparición por un juez de California)
...
A finales de la década de 1930, la aviación de larga distancia vivía una era de hitos insospechados, impulsada por el desarrollo de robustos bimotores de construcción enteramente metálica. Los pioneros del aire buscaban establecer las primeras aerovías de carácter transoceánico regular, uniendo continentes y archipiélagos aislados en un clima de intensa competencia tecnológica y comercial internacional.

### Entorno social
La opinión pública mundial de la era de entreguerras seguía con auténtica devoción las hazañas de las mujeres y hombres que desafiaban las fronteras físicas a bordo de sus aeronaves. Amelia Earhart se había convertido en un icono global del feminismo, el progreso técnico y la audacia humana, inspirando a millones de personas que buscaban en el vuelo de exploración un símbolo de superación y libertad personal.

### Entorno tecnológico
En el plano técnico, el Lockheed L-10E Electra representaba la vanguardia de la aviación comercial gracias a su construcción monoplaca de duraluminio, flaps hidráulicos y tren de aterrizaje retráctil. No obstante, la navegación sobre la inmensidad del océano Pacífico dependía de la brújula, el octante de burbuja y del uso de receptores de radio direccionales que, debido a interferencias atmosféricas y problemas de antena, fallaban de manera constante.

### Entorno cultural
La desaparición de Amelia Earhart en el apogeo de su carrera consagró su figura como un mito imperecedero de la cultura de la aviación mundial, una de esas historias inconclusas que mantienen en vilo a los investigadores del siglo XXI. El misterio que rodea su último vuelo ha inspirado innumerables documentales, libros y largometrajes, donde su gesta es recordada como el símbolo supremo de la pasión por el cielo.
...
- **Madrugada del 1 al 2 de julio de 1937 (hora local de Howland):** Los receptores de radio del guardacostas estadounidense *Itasca*, apostado en Howland para guiar a la aviadora, captan señales de radio fragmentarias y débiles en la oscuridad durante el vuelo de aproximación.
- **08:43 horas del 2 de julio de 1937 (hora de Howland):** Se recibe la última transmisión de voz confirmada de Amelia Earhart informando sobre una línea de posición (157-337) antes de perderse el contacto de radio de forma definitiva.
- **Julio de 1937:** El presidente Franklin D. Roosevelt ordena una operación de búsqueda masiva con barcos de la Armada y el portaaviones *Lexington*, recorriendo miles de millas de agua sin hallar ningún rastro.
- **5 de enero de 1939:** Tras año y medio de investigaciones infructuosas, Amelia Earhart es declarada formalmente fallecida por un tribunal en California, cerrando el registro legal de la misión.

### Consecuencias e Impacto

La trágica y repentina desaparición de Amelia Earhart conmocionó profundamente a la sociedad internacional y redefinió las directrices de seguridad para los vuelos de largo alcance sobre el agua. El misterio obligó a replantear el diseño de las comunicaciones comerciales de emergencia.

- **Revisión de los sistemas de radiocomunicación:** El desastre evidenció la necesidad de estandarizar las frecuencias de emergencia internacionales y de dotar a las aeronaves transoceánicas de mejores antenas de radio direccionales con frecuencias redundantes para evitar la pérdida de comunicación en condiciones de estática.
- **Evolución de las misiones de búsqueda y rescate:** La infructuosa búsqueda del Electra impulsó a las autoridades civiles y militares a desarrollar protocolos sistemáticos de búsqueda y salvamento (*Search and Rescue - SAR*), tratando de trazar mapas de cuadrículas más precisos sobre aguas internacionales.
- **Nacimiento de múltiples hipótesis históricas:** La ausencia de restos físicos dio origen a diversas hipótesis que van desde el hundimiento inminente del avión en el mar (*Crash-and-Sink*), hasta el aterrizaje de emergencia en Nikumaroro (*Gardner Island*) o la supuesta captura de la tripulación por fuerzas japonesas en las islas Marshall.
- **Consolidación de las misiones de Amelia Earhart:** Su trágico fin, lejos de opacar su obra, ayudó a consolidar la trascendencia de sus hitos, inspirando la creación de becas, aeroclubes y premios con su nombre para incentivar la incorporación de la mujer a la ingeniería y la aviación civil.
