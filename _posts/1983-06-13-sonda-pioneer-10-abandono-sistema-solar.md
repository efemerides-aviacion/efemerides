...
pais: Estados Unidos
operator: NASA
excerpt: "El 13 de junio de 1983, la sonda Pioneer 10 se convirtió en el primer objeto de construcción humana en abandonar el Sistema Solar al atravesar la órbita del planeta más distante, Neptuno. Lanzada en 1972, fue la primera nave en atravesar el cinturón de asteroides y sobrevolar Júpiter."
image: 1983-06-13-sonda-pioneer-10-abandono-sistema-solar.webp
---

<figure>
  <img class="post-image" src="{{ site.baseurl }}/assets/img/1983-06-13-sonda-pioneer-10-abandono-sistema-solar.webp" alt="Sonda espacial Pioneer 10 de la NASA">
  <figcaption class="post-caption">Mapa de las trayectorias de las sondas Pioneer 10 y 11, junto a las de Voyager 1 y 2, mostrando su recorrido más allá de los planetas del Sistema Solar; ilustración publicada el 13 de mayo de 2005; fuente: Wikipedia.</figcaption>
</figure>
...
- **Fecha del abandono del Sistema Solar:** 13 de junio de 1983, 5:00 a.m. PDT (hora del Pacífico) 
- **Distancia al Sol en ese momento:** 2.810 millones de millas (4.522 millones de kilómetros) 
- **Planeta más distante superado:** Neptuno (en 1983, Plutón estaba más cerca del Sol debido a su órbita excéntrica) 
- **Velocidad en ese momento:** 27.000-27.500 mph (43.000-44.000 km/h) 
- **Fecha de lanzamiento:** 2 de marzo de 1972 / 3 de marzo de 1972 (UTC) 
- **Lugar de lanzamiento:** Cabo Cañaveral, Florida, Estados Unidos 
- **Masa de la sonda:** 258 kg 
- **Velocidad de lanzamiento:** 32.114 mph (51.682 km/h) 
- **Diámetro de la antena:** 2,74 metros 
- **Fuente de energía:** 4 generadores termoeléctricos de radioisótopos (RTG) 
- **Encuentro con Júpiter:** 3 de diciembre de 1973, a menos de 132.000 km de las nubes 
- **Final de la misión científica:** 31 de marzo de 1997 
- **Último contacto con la Tierra:** 23 de enero de 2003, a 12.000 millones de kilómetros 
- **Destino final:** Estrella Aldebarán (constelación de Tauro) en aproximadamente 1,69-2 millones de años 

<hr style="margin: 2rem 0; border: none; height: 2px; background: linear-gradient(to right, #0d47a1, #29b6f6);">

## Contexto Histórico

A principios de la década de 1970, la exploración del Sistema Solar exterior era uno de los mayores desafíos tecnológicos de la humanidad. Las distancias eran colosales, las condiciones de radiación desconocidas y ningún objeto construido por el hombre había viajado más allá de Marte.

### Entorno social

La carrera espacial entre Estados Unidos y la Unión Soviética estaba en su apogeo. Mientras los alunizajes del programa Apolo capturaban la atención mundial, la NASA también invertía en misiones robóticas para explorar los planetas exteriores. La Pioneer 10 fue concebida como una misión pionera, literalmente, que abriría el camino para naves más complejas como las Voyager.

### Entorno tecnológico

La Pioneer 10 incorporó innovaciones radicales para su época. Fue la primera nave espacial en funcionar completamente con energía nuclear (generadores termoeléctricos de radioisótopos), ya que la luz solar era demasiado débil más allá de Marte para alimentar paneles solares. Su antena de 2,74 metros de diámetro permitía comunicarse con la Tierra a distancias nunca antes alcanzadas. Los 11 instrumentos científicos a bordo —incluyendo detectores de meteoritos, cámara, radiómetro, magnetómetro y analizador de plasma— debían sobrevivir al cinturón de asteroides, cuyos riesgos eran entonces desconocidos.

### Entorno cultural

La Pioneer 10 llevaba a bordo una placa de aluminio dorado de 15 × 23 centímetros, diseñada por Carl Sagan y Frank Drake. La placa mostraba un hombre y una mujer desnudos, la posición del Sol en la galaxia mediante púlsares, y la trayectoria de la nave. Era un mensaje de la humanidad a cualquier civilización extraterrestre que pudiera interceptar la sonda en los milenios venideros.
