...
excerpt: "El 15 de diciembre de 2006, el prototipo AA-1 del F-35 Lightning II realizó su primer vuelo en Fort Worth, Texas, marcando el inicio del programa militar más costoso y ambicioso de la historia, que hoy equipa a más de una docena de países."
image: 2006-12-15-primer-vuelo-f35-aa1.webp
---

<figure>
  <img class="post-image" src="{{ site.baseurl }}/assets/img/2006-12-15-primer-vuelo-f35-aa1.webp" alt="F-35 Lightning II AA-1 en su primer vuelo">
...
- **Lugar:** Lockheed Martin Aeronautics Company, Fort Worth, Texas, EE. UU. (Base de la Fuerza Aérea de Fort Worth, también conocida como Carswell Field)
- **Aeronave:** Lockheed Martin F-35 Lightning II, prototipo AA-1 (número de serie 001, variante F-35A CTOL)
- **Piloto de pruebas:** Jon Beesley (jefe de pilotos de pruebas del F-35 en Lockheed Martin)
- **Duración del vuelo:** 38 minutos (según Lockheed Martin)
- **Altitud máxima alcanzada:** 5.000 pies (1.524 m) - vuelo subsónico y de baja altitud
- **Velocidad máxima:** aproximadamente 250 nudos (463 km/h)
- **Motor:** Pratt & Whitney F135-PW-100 (primer prototipo equipado con este motor)
- **Objetivos del vuelo:** Verificar sistemas de vuelo, tren de aterrizaje, flaps, slats y controlabilidad preliminar
...
### Entorno tecnológico
El F-35 introdujo capacidades revolucionarias:
- **Fusión de sensores:** Integra datos del radar AESA AN/APG-81, el sistema DAS (Distributed Aperture System) de seis cámaras infrarrojas, el sistema EO Targeting System (EOTS) y guerra electrónica.
- **Casco HMDS (Helmet Mounted Display System):** Proyecta información crítica en la visera del piloto y permite “ver a través del avión”, mostrando imágenes de las cámaras del DAS en tiempo real.
- **Capacidad furtiva:** Sección radar equivalente muy baja (RCS del orden de 0.001 m²), comparable a una canica de metal.
- **Supercrucero limitado:** No puede supercrucero sostenido, pero puede alcanzar Mach 1.6 con postquemador.
...
- **Revolución en la guerra aérea:** El F-35 ha cambiado la doctrina de combate, priorizando la conciencia situacional y la fusión de datos sobre la agilidad tradicional. En ejercicios, ha demostrado capacidades de "mata primero" contra cazas de cuarta generación.
- **Impacto económico:** El programa generó cientos de miles de empleos directos e indirectos en EE. UU. y países socios. Lockheed Martin se consolidó como el mayor contratista de defensa del mundo.
