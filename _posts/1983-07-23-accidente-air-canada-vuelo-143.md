---
layout: post
title: "23 de julio de 1983 | El \"Gimli Glider\": el avión que se quedó sin combustible y se convirtió en un planeador"
date: 1983-07-23
categories: [accidente]
author: Enrique Pomares
pais: Canadá
operator: Air Canada
excerpt: "El Boeing 767 de Air Canada (C-GAUN) registra un consumo total de combustible a 41.000 pies por un error de conversión métrica, logrando un milagroso planeo y aterrizaje de emergencia en Gimli."
image: 1983-07-23-accidente-air-canada-vuelo-143.webp
---
...
- **Aeronave:** Boeing 767-233 (matrícula C-GAUN, número de serie 22520, número de flota Air Canada 604).
- **Operador:** Air Canada.
- **Tripulación al mando:** Capitán Robert "Bob" Pearson y Primer Oficial Maurice Quintal.
- **Ocupantes a bordo:** 61 pasajeros y 8 tripulantes (69 personas en total, 0 víctimas mortales, 10 heridos leves durante la evacuación por toboganes).
- **Lugar de aterrizaje de emergencia:** Antiguo aeródromo militar RCAF de Gimli, Manitoba, Canadá.
- **Altitud del apagado total de motores:** 41.000 pies (FL410 / 12.500 metros).
...
### Entorno social
A comienzos de la década de 1980, Canadá se encontraba inmersa en la adopción del sistema métrico decimal. La conversión afectaba las rutinas operativas de la industria de transporte, generando resistencia y confusión operativa en el personal técnico habituado al sistema imperial británico. El Boeing 767 matriculado C-GAUN era el primer avión de la flota de Air Canada configurado de fábrica para operar íntegramente con mediciones en kilogramos y litros, requiriendo un cambio radical en las planillas de carga de combustible.

### Entorno tecnológico
La serie Boeing 767 introduced la cabina de cristal (*glass cockpit*) con instrumentación digital avanzada y el sistema computarizado de indicación de cantidad de combustible (FQIS). No obstante, el sistema del C-GAUN presentaba un fallo intermitente de conexión que llevó al departamento de mantenimiento a desactivar el procesador del FQIS, dejando las pantallas del panel de combustible en blanco. Ante esta inoperatividad, las normas de la aerolínea exigían medir el nivel físico mediante la varilla graduada de medición (*dripstick*), procedimiento en el que intervino el error de conversión de unidades.
...
- **Marzo de 1983:** Entrega e incorporación del Boeing 767-233 C-GAUN a Air Canada como el cuarto avión de este modelo en su flota.
- **22 de julio de 1983:** Mantenimiento detecta lecturas anómalas en el canal de datos del FQIS en Edmonton; el sistema es desactivado temporalmente dejando los marcadores de la cabina fuera de servicio.
- **23 de julio de 1983 (15:00 CDT):** Carga manual de combustible mediante *dripstick* en Montreal y recálculo en la escala de Ottawa. Los técnicos aplican el factor numérico de 1,77 (correspondiente a lb/L) pensando que operaban en libras, cuando el manual exigía multiplicar por 0,8 kg/L, cargando apenas 9.144 kg de combustible en lugar de los 20.400 kg necesarios para llegar a Edmonton.
- **23 de julio de 1983 (20:00 CDT):** El vuelo AC143 despega de Ottawa alcanzando nivel de crucero a 41.000 pies.
- **23 de julio de 1983 (20:38 CDT):** Se activa la alarma de baja presión de combustible en el motor izquierdo sobre Red Lake, Ontario. El motor se apaga minutos después.
- **23 de julio de 1983 (20:45 CDT):** Falla total del motor derecho a 28.000 pies. Las pantallas de instrumentos se apagan y se despliega la turbina de aire de impacto (RAT) para suministrar presión hidráulica de emergencia a los mandos primarios de vuelo.
- **23 de julio de 1983 (20:48 CDT):** El Primer Oficial Quintal calcula que no lograrán alcanzar el aeropuerto alterno de Winnipeg y propone la pista de la antigua base RCAF de Gimli. El Capitán Pearson ejecuta la técnica aerodinámica de resbalamiento lateral (*forward slip*) para perder altura velozmente sin incrementar la velocidad aerodinámica con los motores apagados.
...
- **Timestamp de verificación:** 2026-07-19 07:10:35 America/Mexico_City
...
- **Fuentes secundarias de contraste:** CBC Archives, Time Magazine, Aviation Safety Network, borrador preliminar del investigador.
