...
excerpt: "El 26 de noviembre de 2003, el Concorde G-BOAF ('Alpha Foxtrot') de British Airways realizó su último vuelo desde Heathrow hasta Filton (Bristol), marcando el retiro definitivo del avión supersónico comercial tras 27 años de servicio y cerrando una era en la aviación."
image: 2003-11-26-concorde-gboaf-ultimo-vuelo.webp
---

<figure>
  <img class="post-image" src="{{ site.baseurl }}/assets/img/2003-11-26-concorde-gboaf-ultimo-vuelo.webp" alt="Concorde G-BOAF sobre el puente colgante de Clifton">
...
- **Aeronave:** Aérospatiale-BAC Concorde, modelo 102 (versión para British Airways)
- **Matrícula completa:** G-BOAF (también conocido como "Alpha Foxtrot" o "AF")
- **Número de serie de fábrica:** 216 (último Concorde producido, entregado a British Airways en 1979)
- **Ruta:** Londres Heathrow (LHR) – Aeródromo de Filton (FZO), Bristol, Inglaterra
- **Tiempo de vuelo:** 43 minutos
- **Pilotos:** Capitán Mike Bannister (jefe de pilotos de Concorde de British Airways) y otros tripulantes [NO CONFIRMADO: las fuentes no mencionan al resto de la tripulación]
- **Altitud máxima alcanzada en este vuelo:** Aproximadamente 3.000 pies (vuelo subsónico de traslado, no supersónico)
- **Motivo del vuelo:** Traslado definitivo al lugar de ensamblaje para su preservación museística
...
### Entorno tecnológico
El Concorde podía volar a Mach 2,04 (≈2.179 km/h) a una altitud de crucero de 18.000 metros (60.000 pies), más del doble de la altitud de los aviones subsónicos. Sus motores Rolls-Royce/Snecma Olympus 593, con postquemadores, eran extremadamente complejos y ruidosos. El consumo de combustible por pasajero era mucho mayor que el de un Boeing 747. El mantenimiento requería conocimientos especializados y piezas que ya no se fabricaban. Para 2003, la flota necesitaba una costosa revisión mayor (aproximadamente 30 millones de libras por aeronave), lo que resultaba económicamente inviable.
...
- **Fin de la era supersónica comercial:** Tras 27 años, ningún otro avión de pasajeros ha alcanzado Mach 2 de forma regular. Los aviones supersónicos actuales (como el Boom Overture o el NASA X-59) están aún en fase de desarrollo.
- **Legado tecnológico:** El Concorde demostró que era posible volar a velocidades supersónicas con pasajeros, pero también evidenció los desafíos económicos y ambientales (contaminación acústica, consumo de combustible, costos de mantenimiento).
...
<div class="references">
  <ul>
    <li><a href="https://www.bbc.com/news/uk-25250584" style="color: #315fea; text-decoration: none;">BBC News – Concorde: The final flight (26 noviembre 2013)</a></li>
    <li><a href="https://www.telegraph.co.uk/travel/news/two-decades-on-concorde-still-captivates-obsessives-like-me/" style="color: #315fea; text-decoration: none;">The Telegraph – Concorde’s 20th anniversary of final flight (26 noviembre 2023)</a></li>
    <li><a href="https://aerospacebristol.org/last-concorde" style="color: #315fea; text-decoration: none;">Aerospace Bristol – Concorde G-BOAF (Alpha Foxtrot)</a></li>
    <li><a href="https://www.britishairways.com/en-gb/information/about-ba/history/10-years-since-concorde-retired" style="color: #315fea; text-decoration: none;">British Airways – 10 years since Concorde retired</a></li>
    <li><a href="https://www.britannica.com/technology/Concorde" style="color: #315fea; text-decoration: none;">Britannica – Concorde</a></li>
    <li><a href="https://en.wikipedia.org/wiki/Concorde" style="color: #315fea; text-decoration: none;">Wikipedia (EN) – Concorde</a></li>
    <li><a href="https://en.wikipedia.org/wiki/Concorde_aircraft_G-BOAF" style="color: #315fea; text-decoration: none;">Wikipedia (EN) – Concorde G-BOAF</a></li>
  </ul>
</div>
