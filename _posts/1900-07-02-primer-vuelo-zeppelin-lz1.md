---
layout: post
title: "2 de julio de 1900 | Primer vuelo del Zeppelin LZ 1, el pionero de los dirigibles rígidos"
date: 1900-07-02
categories: [evento]
author: Enrique Pomares
pais: Alemania
operator: Luftschiffbau Zeppelin
excerpt: "El 2 de julio de 1900, el conde Ferdinand von Zeppelin completó con éxito el vuelo inaugural del Zeppelin LZ 1, el primer dirigible rígido experimental del mundo, sobre el lago de Constanza."
image: 1900-07-02-primer-vuelo-zeppelin-lz1.webp
...
- **Detalle de la planta motriz:** Dos motores de combustión interna Daimler de cuatro cilindros refrigerados por agua, que generaban 14,2 CV (10,6 kW) cada uno a nivel del mar
- **Góndolas de tripulación:** Dos barquillas de metal suspendidas debajo de la quilla (una a proa y otra a popa) para albergar de manera segura a los operadores y los motores
- **Mecanismo de tracción:** Cuatro hélices de aluminio de cuatro palas, accionadas mediante engranajes cónicos y largos ejes de transmisión conectados a los motores Daimler
...
### Entorno tecnológico
En el plano tecnológico, el surgimiento de la metalurgia ligera del aluminio, abanderada por el fabricante Carl Berg, y los primeros motores de combustión interna confiables de Gottlieb Daimler hicieron posible el diseño del LZ 1. La estructura de vigas de duraluminio permitió crear un esqueleto rígido e indeformable, capaz de albergar múltiples bolsas de hidrógeno independientes para garantizar la flotabilidad operacional.
...
- **1890:** Tras retirarse de la caballería del ejército prusiano, el conde Ferdinand von Zeppelin patenta sus primeros diseños de un «tren aéreo» de dirigibles rígidos.
- **1898:** Se funda la *Gesellschaft zur Förderung der Luftschifffahrt* en Friedrichshafen con el fin de financiar la construcción del primer prototipo a gran escala.
- **Invierno de 1899:** Comienza el ensamblaje de la estructura de vigas de aluminio del LZ 1 dentro de un gigantesco hangar flotante amarrado en la bahía de Manzell.
- **2 de julio de 1900 (20:00 horas aprox.):** El zepelín es remolcado fuera de su hangar flotante y realiza con éxito su vuelo inaugural de dieciocho minutos sobre el lago de Constanza, llevando cinco ocupantes a bordo.
- **17 de octubre de 1900:** Tras superar reparaciones complejas en el esqueleto de aluminio, el LZ 1 completa un segundo vuelo de prueba de una hora y treinta y dos minutos de duración.
...
- **Validación del esqueleto rígido:** El vuelo del LZ 1 profesó en la práctica la validez de la estructura metálica ligera de duraluminio unida a celdas de gas independientes, un diseño de patente que evitaba la deformación de la envoltura en pleno vuelo y que caracterizó a todos los dirigibles gigantes de la primera mitad del siglo XX.
- **Evolución de los motores de aviación:** El rendimiento de los primeros motores Daimler aceleró el desarrollo de plantas motrices de gran fiabilidad específicas para aeronaves, lo que culminaría con el nacimiento de la fábrica de motores Maybach, subsidiaria del grupo Zeppelin.
...
- **La cuna de la aviación alemana:** La ciudad de Friedrichshafen en el lago de Constanza se consolidó como la capital mundial de los dirigibles, albergando en la actualidad el Museo Zeppelin, donde se exhiben maquetas, planos de duraluminio originales y la memoria del vuelo del 2 de julio de 1900.
