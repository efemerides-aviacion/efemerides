# Instrucciones de formato de salida para efemérides v-1.2 2026-04-06
...
8. **Prohibición de marcadores automáticos:** Al copiar o parafrasear información de fuentes externas, se deben eliminar manualmente todos los marcadores del tipo "[citation:X]", "[[citation:X]]", "[1]", "[2]", etc. ANTES de entregar el documento final. La presencia de estos marcadores invalida automáticamente el producto.