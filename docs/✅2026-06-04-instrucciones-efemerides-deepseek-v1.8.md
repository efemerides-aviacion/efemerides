```markdown
# Instrucciones de formato de salida para efemérides v-1.8 2026-06-04
...
### Ejemplo práctico de política de idiomas

**Incorrecto ❌:** "The Westland Sea King HC.4 ZA294 crashed during a night flight."

**Correcto ✅:** "El Westland Sea King HC.4, matrícula ZA294, se estrelló durante un vuelo nocturno."

**Incorrecto ❌:** "The 846 Naval Air Squadron was operating from HMS Hermes."

**Correcto ✅:** "El Escuadrón Aéreo Naval 846 (846 Naval Air Squadron) operaba desde el HMS Hermes."

**Incorrecto ❌:** Referencia en ruso (`letopis.by`)

**Correcto ✅:** Referencia en inglés (`Russia Beyond`) o español equivalente.
...
5. El mensaje de commit para GitHub Desktop debe seguir el formato:
...
7. **Prohibición de marcadores automáticos:** Al copiar o parafrasear información de fuentes externas, se deben eliminar manualmente todos los marcadores del tipo "[citation:X]", "[1]", "[2]", etc. ANTES de entregar el documento final. La presencia de estos marcadores invalida automáticamente el producto.

8. **Verificación obligatoria de URLs en referencias:**
...
## Pautas de redacción para evitar repeticiones innecesarias

Cada sección del post tiene una función específica. La información puede aparecer en varias secciones (ej. Resumen Ejecutivo y cuerpo), pero debe estar **ampliada o presentada desde otra perspectiva**, no repetida textualmente.

### Jerarquía de la información

- **Excerpt (YAML):** Frase para SEO y listados. Longitud sugerida: 1 línea.
- **Resumen Ejecutivo:** Síntesis de todo el post. Longitud sugerida: 2-3 párrafos.
- **Cuerpo del post:** Desarrollo ampliado de la síntesis. Longitud: según necesidad.

### Reglas por sección

- **Excerpt:** Versión más breve del evento. NO incluir datos secundarios.
- **Resumen Ejecutivo:** Lo esencial del evento (quién, qué, cuándo, dónde, por qué). Debe añadir al menos un dato que no esté en el excerpt. NO repetir textualmente el excerpt.
- **Datos verificados del evento:** Solo datos NO mencionados en el Resumen Ejecutivo. NO repetir lo que ya está en el Resumen.
- **Contexto Histórico:** Entorno social, tecnológico, cultural. NO repetir la biografía del protagonista ni fechas del evento principal.
- **Desarrollo Cronológico:** Lista de hitos con fechas. NO repetir información del Resumen Ejecutivo.
- **Consecuencias e Impacto:** Efectos inmediatos y a corto plazo (días, semanas, meses). NO incluir efectos a largo plazo (años, décadas).
- **Legado:** Efectos a largo plazo, memoria histórica, reconocimiento póstumo. NO repetir consecuencias inmediatas.
- **Secciones específicas** (ej. Sistema de acreditación, Efecto Coandă): Información única del evento que no encaja en otras secciones. NO repetir lo ya dicho en otras secciones.

### Ejemplo práctico (aplicado a una efeméride de nacimiento)

**Excerpt:**
```yaml
excerpt: "El 27 de marzo de 1894 nació René Paul Fonck, el as de ases aliado de la Primera Guerra Mundial con 75 victorias confirmadas."
```

**Resumen Ejecutivo (amplía el excerpt con lugar y comparación):**
```html
<p>Nacido en Saulcy-sur-Meurthe, Francia, Fonck fue el as aliado con más victorias de la Primera Guerra Mundial: 75 confirmadas (72 en solitario). Solo superado por Manfred von Richthofen (80), destacó por su precisión y economía de munición.</p>
```

**Datos verificados (solo lo nuevo, no repite las 75 victorias):**
```markdown
- **Fallecimiento:** 18 de junio de 1953 (59 años), París, Francia
- **Aeronaves:** Caudron G.III, SPAD VII, SPAD XII, SPAD XIII
- **Condecoraciones:** Gran Oficial de la Legión de Honor, Cruz de Guerra 1914-1918 (26 palmas)
```

### Regla de oro

> **La misma información no debe aparecer redactada de la misma manera en dos secciones diferentes del cuerpo del post. Si aparece, una de las dos debe eliminarse o reformularse desde otra perspectiva.**
```