...
> Última actualización: 2026-07-01 Versión: v2026-06
...
## Categoría
[nacimiento / evento / fundacion / accidente / seguridad / supervivencia / espacial]
...
## Imagen
AAAA-MM-DD-nombre-de-la-imagen.webp (**Igual al archivo del post solo que cambia la extensión de ".md" a ".webp"**)

## Pie de foto
[Descripción de la imagen con fuente y fecha]
...
8. **Si el usuario deja el campo "Título del post" en blanco, generar un título siguiendo el formato estándar: "[Fecha] | [Descripción concisa del evento]".**
...
4. **Datos técnicos e históricos**  
   ...
   - Si un dato relevante no pudo ser confirmed, se omite de la lista o se explica en la Nota Aclaratoria.
...
5. **Cuerpo principal – Secciones temáticas**  
   ...
   - **REGLAS OBLIGATORIAS PARA TÍTULOS Y SUBTÍTULOS:**
     - **Rigidez Estructural de las Cabeceras:** Queda estrictamente prohibida la modificación, traducción o alteración unilateral de las cabeceras normativas definidas en las plantillas (como `## Datos verificados del evento`, `## Contexto Histórico`, `## Desarrollo Cronológico`, etc.). Deben transcribirse de manera exacta en su formato e idioma original de la plantilla.
     - **Consulta Previa Obligatoria:** Si el asistente considera que alguna cabecera normativa no se adapta al evento, debe detener el proceso de generación y consultar de manera explícitamente al usuario antes de aplicar cualquier propuesta de cambio.
...
- **Lista Negra de Vocabulario y Expresiones Prohibidas:** Queda terminantemente prohibido utilizar términos ambiguos o calcos del inglés como «avión desarmado» (usar *«avión sin armamento»*), «la nave se asienta» (usar *«se sitúa / se inserta en órbita»*), la palabra redundante «fáctica/fáctico» (sustituir por *«plenamente»*, *«efectivamente»*, *«en la práctica»*) y anglicismos sin traducir como «sponsons» (usar *«aletas estabilizadoras de quilla»*).
- **Control de Lectura de Archivos Obligatorio:** Antes de entregar o presentar cualquier post final en el chat, el asistente debe realizar de manera obligatoria una lectura completa del archivo final mediante `read_file` para verificar que no existan mezclas con datos de posts anteriores, fragmentos inconexos de otras plantillas o notas de autocrítica internas impresas por error.
...
| :--- | :--- | :--- | :--- |
| v2026-03 | 2026-05-06 | Editor de Efemérides | Versión inicial de control y pautas operativas en el repositorio. |
| v2026-04 | 2026-06-23 | Editor de Efemérides | Ajustes finos de formato numérico (miles/decimales), exclusión de marcadores de cita y checklist final. |
| v2026-05 | 2026-06-28 | Kang Wildan | Adición de las políticas de «Rigidez Estructural de Cabeceras» y «Consulta Previa Obligatoria» ante inconsistencias reales. |
| v2026-06 | 2026-06-28 | Kang Wildan | Inclusión formal de la «Lista Negra de Vocabulario» (prohibición de avión desarmado/asienta/fáctico/sponsons sin traducir) y el protocolo de «Control de Lectura Obligatorio» previo a la entrega. |