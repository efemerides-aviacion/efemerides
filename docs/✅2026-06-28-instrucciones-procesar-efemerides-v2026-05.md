...
> Última actualización: 2026-06-28 Versión: v2026-05
...
5. **Cuerpo principal – Secciones temáticas**  
   ...
   - **REGLAS OBLIGATORIAS PARA TÍTULOS Y SUBTÍTULOS:**
     ...
     - **Consulta Previa Obligatoria:** Si el asistente considera que alguna cabecera normativa no se adapta al evento, debe detener el proceso de generación y consultar de manera explícita al usuario antes de aplicar cualquier propuesta de cambio.
